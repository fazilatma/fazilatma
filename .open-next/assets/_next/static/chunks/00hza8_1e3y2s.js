(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,56722,t=>{"use strict";var e=t.i(19614);t.s(["generateInvoiceHTML",0,t=>{let s=(0,e.getCachedLiveContent)();return`
<!DOCTYPE html>
<html lang="fa" dir="rtl">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>فاکتور رسمی - ${t.id}</title>
...
<body>
        ...
        <div class="w-1/3 text-left">
          <table class="w-full text-sm">
            <tr>
              ...
              <td class="pb-2 font-bold text-gray-800 text-left" dir="ltr">${t.id}</td>
            </tr>
            <tr>
              <td class="pb-2"><div class="bilingual"><span class="fa-text">تاريخ:</span><span class="en-text">Date</span></div></td>
              <td class="pb-2 font-bold text-gray-800 text-left" dir="ltr">${t.date}</td>
            </tr>
            <tr>
          ...
          <tbody class="bg-white">
            <tr class="border-b border-gray-200">
              ...
              <td class="py-4 px-4 border-l border-gray-200 text-right">
                <div class="font-bold text-gray-800">${t.product}</div>
                <div class="text-xs text-gray-500 mt-1" dir="ltr">${t.product} (Official)</div>
              </td>
              <td class="py-4 px-2 border-l border-gray-200">Apple</td>
              <td class="py-4 px-2 border-l border-gray-200 font-bold">1</td>
              <td class="py-4 px-4 border-l border-gray-200">${t.amount}</td>
              <td class="py-4 px-2 border-l border-gray-200">9%</td>
              <td class="py-4 px-4 font-bold text-gray-900">${t.amount}</td>
            </tr>
      ...
      <div class="flex justify-between items-stretch mb-8 gap-8">
        ...
        <div class="w-1/2 border border-gray-200 rounded-xl overflow-hidden bg-white">
          <table class="w-full text-sm font-bold">
            <tr class="border-b border-gray-200">
              <td class="p-3 text-center border-l border-gray-200">${t.amount}</td>
            ...
            <tr class="border-b border-gray-200 bg-[#003b5c] text-white">
              <td class="p-3 text-center border-l border-[#005e94] text-lg">${t.amount}</td>
            ...
            <tr class="bg-gray-100">
              <td class="p-4 text-center border-l border-gray-200 text-xl text-[#0b9c56]">${t.amount}</td>
        ...
        <div class="w-1/3 flex flex-col items-center justify-center border-r border-gray-300 pr-6">
          ...
          <div class="flex items-center gap-4 w-full">
            ...
            <div class="w-24 h-24 bg-white p-1 border border-gray-300 rounded shrink-0 flex items-center justify-center">
              <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://optibid.ir/verify/${t.id}" class="w-full h-full" alt="QR Code">
            </div>
          </div>
  ...
  `}])},98585,t=>{"use strict";var e=t.i(43476),s=t.i(22016),a=t.i(71645),r=t.i(56722);t.s(["default",0,function(){let[t,l]=(0,a.useState)("all"),d=[{id:"ORD-1403-001",buyer:"شرکت فناوران نوین",product:"لپ‌تاپ استوک Lenovo ThinkPad T480 × 5 عدد",totalAmount:"۱۴۰,۰۰۰,۰۰۰ تومان",feeAmount:"۷,۰۰۰,۰۰۰ تومان (۵٪ کمیسیون)",sellerReceives:"۱۳۳,۰۰۰,۰۰۰ تومان",status:"delivered",statusLabel:"در انتظار تایید نهایی خریدار",statusColor:"bg-orange-100 text-orange-700",paidAt:"۱۴۰۳/۰۸/۱۵",needShipment:!1,canGetPaid:!0},{id:"ORD-1403-002",buyer:"رستوران سنتی بهارستان",product:"تجهیزات آشپزخانه صنعتی × ۱ ست",totalAmount:"۸۰,۰۰۰,۰۰۰ تومان",feeAmount:"۴,۰۰۰,۰۰۰ تومان",sellerReceives:"۷۶,۰۰۰,۰۰۰ تومان",status:"paid",statusLabel:"پرداخت شده - آماده ارسال",statusColor:"bg-blue-100 text-blue-700",paidAt:"۱۴۰۳/۰۸/۱۸",needShipment:!0,canGetPaid:!1},{id:"ORD-1403-003",buyer:"سارا احمدی",product:"آیپد پرو ۲۰۲۲ × ۱ عدد",totalAmount:"۴۲,۰۰۰,۰۰۰ تومان",feeAmount:"۲,۱۰۰,۰۰۰ تومان",sellerReceives:"۳۹,۹۰۰,۰۰۰ تومان",status:"completed",statusLabel:"تکمیل شده - مبلغ واریز شد",statusColor:"bg-green-100 text-green-700",paidAt:"۱۴۰۳/۰۷/۱۰",needShipment:!1,canGetPaid:!1}],i="all"===t?d:d.filter(e=>e.status===t);return(0,e.jsx)("div",{dir:"rtl",className:"min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-8",children:(0,e.jsxs)("div",{className:"max-w-7xl mx-auto",children:[(0,e.jsxs)("div",{className:"mb-8",children:[(0,e.jsx)("h1",{className:"text-3xl font-bold text-gray-900 mb-2",children:"فروش‌های من"}),(0,e.jsx)("p",{className:"text-gray-600",children:"مدیریت معاملات، ارسال کالا و پیگیری تسویه حساب کمیسیون."})]}),(0,e.jsxs)("div",{className:"bg-gradient-to-l from-green-50 to-blue-50 border border-green-200 rounded-xl p-5 mb-6",children:[(0,e.jsx)("h3",{className:"font-bold text-green-800 mb-2",children:"🔒 نحوه تسویه حساب با فروشنده:"}),(0,e.jsxs)("ul",{className:"text-sm text-green-700 space-y-1 mr-5 list-disc",children:[(0,e.jsx)("li",{children:"وجه توسط خریدار به حساب امانی پلتفرم واریز می‌شود."}),(0,e.jsx)("li",{children:"شما کالا را ارسال کرده و کد رهگیری را ثبت می‌کنید."}),(0,e.jsx)("li",{children:"پس از تایید نهایی تحویل توسط خریدار، مبلغ نهایی (با کسر ۵٪ کمیسیون پلتفرم) به کیف پول شما واریز می‌گردد."})]})]}),(0,e.jsx)("div",{className:"flex flex-wrap gap-2 mb-6 bg-white rounded-xl p-2 border border-gray-200",children:[{id:"all",label:"همه فروش‌ها"},{id:"paid",label:"پرداخت شده / در انتظار ارسال"},{id:"shipped",label:"ارسال شده"},{id:"delivered",label:"در انتظار تایید خریدار"},{id:"completed",label:"تکمیل شده (وجه واریز شده)"}].map(s=>(0,e.jsx)("button",{onClick:()=>l(s.id),className:`px-4 py-2 rounded-lg text-sm font-bold transition ${t===s.id?"bg-blue-600 text-white":"text-gray-600 hover:bg-gray-100"}`,children:s.label},s.id))}),(0,e.jsx)("div",{className:"space-y-4",children:0===i.length?(0,e.jsxs)("div",{className:"bg-white rounded-2xl p-16 text-center border border-gray-100",children:[(0,e.jsx)("div",{className:"text-5xl mb-4",children:"💼"}),(0,e.jsx)("h3",{className:"font-bold text-gray-800 mb-2",children:"هنوز فروشی در این بخش ندارید"}),(0,e.jsx)(s.default,{href:"/requests",className:"text-blue-600 font-bold hover:underline",children:"مشاهده درخواست‌های خرید جدید"})]}):i.map(t=>(0,e.jsxs)("div",{className:"bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden",children:[(0,e.jsx)("div",{className:"bg-gray-50 p-4 border-b border-gray-100 flex flex-col md:flex-row md:items-center md:justify-between gap-3",children:(0,e.jsxs)("div",{className:"flex flex-wrap items-center gap-3",children:[(0,e.jsx)("span",{className:"font-mono font-bold text-gray-800",dir:"ltr",children:t.id}),(0,e.jsx)("span",{className:`px-3 py-1 rounded-full text-xs font-bold ${t.statusColor}`,children:t.statusLabel}),(0,e.jsxs)("span",{className:"text-sm text-gray-500",children:["خریدار: ",t.buyer]})]})}),(0,e.jsxs)("div",{className:"p-5",children:[(0,e.jsx)("p",{className:"font-bold text-gray-800 mb-4",children:t.product}),(0,e.jsxs)("div",{className:"grid md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm mb-4 p-4 bg-gray-50 rounded-xl",children:[(0,e.jsxs)("div",{children:[(0,e.jsx)("span",{className:"text-gray-500 block",children:"مبلغ کل پرداختی خریدار:"}),(0,e.jsx)("span",{className:"font-bold text-green-700",children:t.totalAmount})]}),(0,e.jsxs)("div",{children:[(0,e.jsx)("span",{className:"text-gray-500 block",children:"کمیسیون پلتفرم (۵٪):"}),(0,e.jsx)("span",{className:"font-bold text-red-600 line-through",children:t.feeAmount})]}),(0,e.jsxs)("div",{children:[(0,e.jsx)("span",{className:"text-gray-500 block",children:"مبلغ قابل دریافت شما:"}),(0,e.jsx)("span",{className:"font-bold text-green-700 text-lg",children:t.sellerReceives})]}),(0,e.jsxs)("div",{children:[(0,e.jsx)("span",{className:"text-gray-500 block",children:"تاریخ پرداخت:"}),(0,e.jsx)("span",{className:"font-medium",children:t.paidAt})]})]}),(0,e.jsxs)("div",{className:"flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-100",children:[(0,e.jsxs)("button",{onClick:()=>{let e=new Blob([(0,r.generateInvoiceHTML)({id:t.id,date:t.paidAt,amount:t.totalAmount,seller:"شما",product:t.product,status:t.statusLabel})],{type:"text/html;charset=utf-8"}),s=URL.createObjectURL(e);window.open(s,"_blank")},className:"border border-[#00a8e8] text-[#00a8e8] px-5 py-2.5 rounded-lg font-bold hover:bg-blue-50 transition text-center flex items-center justify-center gap-2",children:[(0,e.jsx)("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,e.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"})}),"چاپ پیش‌فاکتور"]}),(0,e.jsx)(s.default,{href:"#",className:"border border-gray-300 text-gray-700 px-5 py-2.5 rounded-lg font-bold hover:bg-gray-50 transition text-center",children:"جزئیات"}),t.needShipment&&(0,e.jsx)("button",{className:"bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg font-bold transition flex-1 sm:flex-none",children:"ثبت کد رهگیری و ارسال کالا"}),t.canGetPaid&&(0,e.jsx)("div",{className:"text-sm text-orange-700 bg-orange-50 px-4 py-2.5 rounded-lg flex-1 flex items-center justify-center",children:"پس از تایید نهایی خریدار، مبلغ به کیف پول شما واریز می‌شود."}),"completed"===t.status&&(0,e.jsxs)("button",{className:"bg-green-600 text-white px-5 py-2.5 rounded-lg font-bold flex-1 sm:flex-none flex items-center justify-center gap-2",children:[(0,e.jsx)("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,e.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M5 13l4 4L19 7"})}),"مبلغ به کیف پول واریز شد"]})]})]})]},t.id))})]})})}])}]);