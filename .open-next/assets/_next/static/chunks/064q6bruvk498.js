(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,11777,t=>{"use strict";var e=t.i(43476);let s={sm:"text-sm",md:"text-lg",lg:"text-2xl"};t.s(["default",0,function({score:t,size:a="md",showLabel:r=!0,light:l=!1,className:i=""}){let d=Math.max(0,Math.min(5,t/20)),n=Math.round(d);return(0,e.jsxs)("div",{className:`inline-flex items-center gap-1.5 ${i}`,"aria-label":`امتیاز ${d.toFixed(1)} از ۵`,children:[(0,e.jsx)("span",{className:`tracking-tight text-amber-400 ${s[a]}`,"aria-hidden":"true",children:Array.from({length:5},(t,e)=>e<n?"★":"☆").join("")}),r&&(0,e.jsxs)("span",{className:`font-bold ${l?"text-white":"text-[#003b5c]"}`,children:[d.toLocaleString("fa-IR",{minimumFractionDigits:1,maximumFractionDigits:1}),(0,e.jsx)("span",{className:`mr-0.5 text-xs font-normal ${l?"text-blue-100":"text-gray-500"}`,children:"از ۵"})]})]})}])},59411,t=>{"use strict";var e=t.i(43476),s=t.i(71645);let a={buyer:[["quality","کیفیت و سلامت کالا"],["match","تطابق کالا با پیشنهاد"],["shipping","سرعت و تعهد در ارسال"],["packaging","بسته‌بندی و تحویل"],["communication","پاسخ‌گویی و رفتار فروشنده"]],seller:[["clarity","شفافیت و دقت درخواست"],["cooperation","همکاری در فرایند معامله"],["communication","ارتباط و پاسخ‌گویی خریدار"],["receipt","سرعت بررسی و تایید دریافت"],["conduct","رفتار حرفه‌ای در معامله"]]};function r({value:t,onChange:s}){return(0,e.jsx)("div",{className:"flex gap-1",dir:"ltr",children:[1,2,3,4,5].map(a=>{let r=a<=t;return(0,e.jsx)("button",{type:"button",onClick:()=>s(a),className:`text-3xl transition hover:scale-110 ${r?"text-amber-400":"text-gray-300 hover:text-amber-300"}`,"aria-label":`${a} ستاره`,children:r?"★":"☆"},a)})})}t.s(["default",0,function({role:t,reviewerId:l,order:i,onSaved:d}){let n=a[t],[o,c]=(0,s.useState)(Object.fromEntries(n.map(([t])=>[t,0]))),[p,x]=(0,s.useState)(""),[b,g]=(0,s.useState)(!1),f=Object.values(o).filter(t=>t>0),m=f.length===n.length,v=m?Math.round(f.reduce((t,e)=>t+e,0)/f.length):0,u="buyer"===t?i.sellerName:i.buyerName,y=async()=>{if(!m)return void alert("لطفاً برای همه معیارهای نظرسنجی امتیاز ستاره‌ای ثبت کنید.");g(!0);try{let t=await fetch("/api/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({orderId:i.id,reviewerId:l,overall:v,scores:o,comment:p})}),e=await t.json();if(!e.success)throw Error(e.message);alert(e.message),await d()}catch(t){alert(t instanceof Error?t.message:"ثبت نظرسنجی ناموفق بود.")}finally{g(!1)}};return(0,e.jsxs)("article",{className:"rounded-3xl border border-gray-200 bg-white p-6 shadow-sm",children:[(0,e.jsxs)("div",{className:"mb-5 flex flex-col justify-between gap-3 sm:flex-row sm:items-center",children:[(0,e.jsxs)("div",{children:[(0,e.jsxs)("p",{className:"text-xs font-bold text-[#00a8e8]",children:["سفارش ",i.id]}),(0,e.jsxs)("h3",{className:"mt-1 text-lg font-bold text-[#003b5c]",children:["ارزیابی ",u]}),(0,e.jsx)("p",{className:"mt-1 text-sm text-gray-500",children:i.title})]}),(0,e.jsxs)("div",{className:"rounded-xl bg-amber-50 px-4 py-2 text-center",children:[(0,e.jsxs)("p",{className:"text-2xl text-amber-400",children:["★".repeat(v),"☆".repeat(5-v)]}),(0,e.jsx)("p",{className:"text-xs font-bold text-amber-800",children:m?`امتیاز نهایی ${v} از ۵`:"هنوز امتیازی ثبت نشده"})]})]}),(0,e.jsx)("div",{className:"space-y-3 border-y border-gray-100 py-5",children:n.map(([t,s])=>(0,e.jsxs)("div",{className:"flex flex-col justify-between gap-2 rounded-xl bg-gray-50 px-4 py-3 sm:flex-row sm:items-center",children:[(0,e.jsx)("span",{className:"text-sm font-bold text-gray-700",children:s}),(0,e.jsx)(r,{value:o[t],onChange:e=>c({...o,[t]:e})})]},t))}),(0,e.jsx)("label",{className:"mt-5 block text-sm font-bold text-gray-700",children:"توضیحات شما (اختیاری)"}),(0,e.jsx)("textarea",{value:p,onChange:t=>x(t.target.value),placeholder:"تجربه واقعی خود از این معامله را بنویسید...",className:"mt-2 min-h-24 w-full rounded-xl border border-gray-200 p-3 text-sm outline-none focus:border-[#00a8e8]"}),(0,e.jsx)("p",{className:"mt-2 text-xs leading-6 text-gray-500",children:"متن این بخش دقیقاً در قسمت «دیدگاه‌ها» صفحه طرف مقابل نمایش داده می‌شود."}),(0,e.jsx)("button",{type:"button",disabled:b||!m,onClick:y,className:"mt-4 rounded-xl bg-[#003b5c] px-6 py-3 text-sm font-bold text-white transition hover:bg-[#002d46] disabled:bg-gray-400",children:b?"در حال ثبت...":"ثبت نهایی امتیاز و نظر"})]})}])},56722,t=>{"use strict";var e=t.i(19614);t.s(["generateInvoiceHTML",0,t=>{let s=(0,e.getCachedLiveContent)();return`
<!DOCTYPE html>
