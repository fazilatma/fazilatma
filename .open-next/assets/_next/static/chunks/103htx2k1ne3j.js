(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,19614,e=>{"use strict";var t=e.i(71645),i=e.i(47167);let a="optibid:live-content",r={cityFa:"تبریز",cityEn:"Tabriz",streetFa:"خیابان ولیعصر",contactAddressFa:"تبریز، خیابان ولیعصر، برج فناوری، طبقه ۱۰",footerAddressFa:"تبریز، خیابان ولیعصر",invoiceCompanyAddressFa:"تبریز، خیابان ولیعصر، مجتمع تجاری نور",invoiceCompanyAddressEn:"No.123, Valiasr St., Tabriz, Iran",invoiceShippingAddressFa:"تبریز، جاده مخصوص، کیلومتر ۱۴",registerCityExampleFa:"تبریز، تبریز"},o=i.default.env.NEXT_PUBLIC_LIVE_CONTENT_BRANCH||"arena/01a020d5-fazilatma";function s(e){return"string"==typeof e&&e.trim().length>0?e.trim():void 0}function n(e){let t=e&&"object"==typeof e?e:{},i=s(t.cityFa)||r.cityFa,a=s(t.cityEn)||r.cityEn,o=s(t.streetFa)||r.streetFa;return{cityFa:i,cityEn:a,streetFa:o,contactAddressFa:s(t.contactAddressFa)||`${i}، ${o}، برج فناوری، طبقه ۱۰`,footerAddressFa:s(t.footerAddressFa)||`${i}، ${o}`,invoiceCompanyAddressFa:s(t.invoiceCompanyAddressFa)||`${i}، ${o}، مجتمع تجاری نور`,invoiceCompanyAddressEn:s(t.invoiceCompanyAddressEn)||`No.123, Valiasr St., ${a}, Iran`,invoiceShippingAddressFa:s(t.invoiceShippingAddressFa)||`${i}، جاده مخصوص، کیلومتر ۱۴`,registerCityExampleFa:s(t.registerCityExampleFa)||`${i}، ${i}`}}function l(){if(window.__OPTIBID_LIVE_CONTENT__)return window.__OPTIBID_LIVE_CONTENT__;try{let e=window.localStorage.getItem(a);return e?n(JSON.parse(e)):null}catch{return null}}i.default.env.NEXT_PUBLIC_LIVE_CONTENT_URL,i.default.env.NEXT_PUBLIC_LIVE_CONTENT_API_URL||encodeURIComponent(o),e.s(["getCachedLiveContent",0,function(){return l()||r},"useLiveContent",0,function(e=r){let[i,o]=(0,t.useState)(()=>l()||e);return(0,t.useEffect)(()=>{let e=!1;return fetch(`/api/live-content?ts=${Date.now()}`,{cache:"no-store"}).then(e=>e.ok?e.json():null).then(t=>{if(!t||e)return;let i=n(t);window.__OPTIBID_LIVE_CONTENT__=i;try{window.localStorage.setItem(a,JSON.stringify(i))}catch{}o(i)}).catch(()=>void 0),()=>{e=!0}},[]),i}],19614)},56722,e=>{"use strict";var t=e.i(19614);function i(e){return"number"==typeof e?Math.max(0,Math.round(e)):Math.max(0,Number(String(e||"").replace(/[۰-۹]/g,e=>String("۰۱۲۳۴۵۶۷۸۹".indexOf(e))).replace(/[٠-٩]/g,e=>String("٠١٢٣٤٥٦٧٨٩".indexOf(e))).replace(/\D/g,""))||0)}function a(e){let t=i(e);return t?`${t.toLocaleString("fa-IR")} تومان`:"۰ تومان"}function r(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function o(e,t){return t?`<div class="spec-row"><span>${r(e)}</span><b>${r(t)}</b></div>`:""}e.s(["generateInvoiceHTML",0,e=>{var s;let n=(0,t.getCachedLiveContent)(),l=e.id||e.orderId||`INV-${Date.now()}`,d=e.date||new Date().toLocaleDateString("fa-IR"),p=e.sellerName||e.seller||"فروشنده OptiBid",c=e.buyerName||e.buyer||"خریدار OptiBid",b=e.product||e.title||"کالای مورد معامله",g=e.description||e.productDescription||"",m=e.category||"کالا / خدمات",x=Math.max(1,Number(e.quantity||1)||1),h=i(e.totalAmount??e.amount),f=i(e.unitAmount)||Math.round(h/x),u=i(e.platformFee),v=i(e.sellerAmount)||Math.max(0,h-u),y=i(e.taxAmount),w=i(e.shippingAmount),N=h+y+w,j=e.productSpecs||{},k=`https://optibid.fazilat-ma.workers.dev/verify/${encodeURIComponent(l)}`,$=j.brand||e.brand||"—",z=[j.exactModel,j.cpu,j.ram,j.storage].filter(Boolean).join(" · "),A=[o("برند",j.brand),o("مدل دقیق",j.exactModel),o("کد مدل / کانفیگ",j.serialOrConfig),o("پردازنده",j.cpu),o("رم",j.ram),o("حافظه",j.storage),o("گرافیک",j.gpu),o("نمایشگر",j.display),o("سال ساخت",j.manufactureYear),o("وضعیت کالا",j.productCondition),o("گارانتی",j.warrantyStatus),o("سلامت کلی قطعات",j.partsHealth),o("سلامت باتری",j.batteryHealthPercent?`${j.batteryHealthPercent}%`:""),o("گرید ظاهری",j.appearanceGrade),o("سابقه تعمیر",j.repairHistory),o("مهلت تست",j.testDeadlineDays?`${j.testDeadlineDays} روز`:"")].filter(Boolean).join("");return`<!DOCTYPE html>
<html lang="fa" dir="rtl">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>فاکتور رسمی معامله - ${r(l)}</title>
  ...
  <main class="sheet">
    ...
    <section class="content">
      <header class="header">
        ...
        <div class="meta">
          <div class="meta-row"><span>شماره سند / Document No.</span><b>${r(l)}</b></div>
      ...
      <section class="party-grid">
        <article class="party-card">
          ...
          <div class="info-row"><span>آدرس</span><b>${r(n.invoiceCompanyAddressFa)}</b></div>
        ...
        <article class="party-card">
          ...
          <div class="info-row"><span>آدرس تحویل</span><b>${r(e.shippingAddress||n.invoiceShippingAddressFa)}</b></div>
          <div class="info-row"><span>شماره سفارش</span><b dir="ltr">${r(l)}</b></div>
          <div class="info-row"><span>روش پرداخت</span><b>${r("wallet"===e.paymentMethod?"کیف پول":"zarinpal"===e.paymentMethod?"زرین‌پال":"gateway"===e.paymentMethod?"درگاه پرداخت آزمایشی":"ثبت دستی")}</b></div>
      ...
      <section class="summary-grid">
        ...
        <article class="totals">
          ...
          <div class="total-row highlight"><span>جمع کل قابل پرداخت</span><b>${a(N)}</b></div>
      ...
      ${A?`<section class="specs"><h3>مشخصات کالای تاییدشده قبل از پرداخت</h3><div class="spec-grid">${A}</div>${j.returnPolicy?`<div style="margin-top:10px;border-radius:12px;background:#ecfdf5;padding:10px;font-size:11px;color:#166534"><b>شرایط مرجوعی:</b> ${r(j.returnPolicy)}</div>`:""}</section>`:""}
        ...
        <article class="box">
          ...
          <div class="verify-inner">
            <div style="font-size:11px;line-height:2;color:#334155">
              ...
              <div dir="ltr" style="margin-top:8px;color:#003b5c;font-weight:800">${r(l)}</div>
            </div>
