    ...
    <section class="content">
      ...
      <section class="summary-grid">
        ...
        <article class="totals">
          ...
          <div class="total-row highlight"><span>جمع کل قابل پرداخت</span><b>${r(N)}</b></div>
      ...
      ${I?`<section class="specs"><h3>مشخصات کالای تاییدشده قبل از پرداخت</h3><div class="spec-grid">${I}</div>${j.returnPolicy?`<div style="margin-top:10px;border-radius:12px;background:#ecfdf5;padding:10px;font-size:11px;color:#166534"><b>شرایط مرجوعی:</b> ${i(j.returnPolicy)}</div>`:""}</section>`:""}
      ...
      <section class="verification">
        ...
        <article class="box">
          ...
          <div class="verify-inner">
            ...
            <div class="qr"><img alt="QR" src="https://api.qrserver.com/v1/create-qr-code/?size=160x160&data=${encodeURIComponent($)}" /></div>
          </div>
        </article>
      </section>
