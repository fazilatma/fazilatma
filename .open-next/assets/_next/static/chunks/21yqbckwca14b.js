(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,65816,e=>{"use strict";e.s(["productImageUrl",0,function(e){if(!e?.storedName)return"";let t=e.id||e.storedName;return`/api/product-image?name=${encodeURIComponent(e.storedName)}&v=${encodeURIComponent(t)}`}])},12682,e=>{"use strict";var t=e.i(43476),a=e.i(65816);function r({title:e,category:a,compact:i=!1}){let s=function(e,t=""){let a=`${e} ${t}`.toLowerCase();return/لپ|لب تاب|لپتاپ|laptop|notebook|thinkpad|vostro|latitude|dell|lenovo|asus|rog|hp|macbook|acer/.test(a)?"laptop":/موبایل|گوشی|mobile|phone|iphone|samsung|xiaomi|tablet|تبلت/.test(a)?"phone":/خودرو|ماشین|موتور|car|auto/.test(a)?"car":/کتاب|تحریر|book|stationery/.test(a)?"book":/پوشاک|لباس|کفش|مد|clothes|fashion/.test(a)?"clothes":/خانه|آشپزخانه|home|kitchen/.test(a)?"home":/زیبایی|سلامت|آرایشی|health|beauty/.test(a)?"health":/ورزش|سفر|sport|travel/.test(a)?"sport":/اسباب|کودک|toy|baby/.test(a)?"toy":/صنعتی|اداری|industrial|office/.test(a)?"industrial":/دیجیتال|digital|ssd|ram|cpu|gpu|monitor/.test(a)?"laptop":"generic"}(e,a);return"laptop"===s?(0,t.jsxs)("div",{className:"relative grid h-full w-full place-items-center overflow-hidden bg-white",children:[(0,t.jsx)("div",{className:"absolute inset-0 bg-gradient-to-br from-sky-50 via-white to-emerald-50"}),(0,t.jsxs)("div",{className:"relative flex h-[88%] w-[88%] flex-col items-center justify-center",children:[(0,t.jsx)("div",{className:"w-[88%] rounded-t-2xl border-[5px] border-slate-800 bg-slate-900 p-1 shadow-xl",children:(0,t.jsx)("div",{className:"aspect-video overflow-hidden rounded-lg bg-gradient-to-br from-sky-300 via-indigo-200 to-emerald-200",children:(0,t.jsx)("div",{className:"h-full w-full bg-[radial-gradient(circle_at_35%_28%,rgba(255,255,255,.9),transparent_18%),linear-gradient(135deg,rgba(255,255,255,.4),transparent_45%)]"})})}),(0,t.jsx)("div",{className:"h-3 w-full rounded-b-2xl bg-slate-300 shadow-md"}),(0,t.jsx)("div",{className:"mt-1 h-1.5 w-[58%] rounded-b-full bg-slate-400/80"})]})]}):(0,t.jsxs)("div",{className:"relative grid h-full w-full place-items-center overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-200",children:[(0,t.jsx)("div",{className:"absolute -left-8 -top-8 h-24 w-24 rounded-full bg-[#00a8e8]/10"}),(0,t.jsx)("div",{className:"absolute -bottom-8 -right-8 h-28 w-28 rounded-full bg-[#0b9c56]/10"}),(0,t.jsxs)("div",{className:"text-center",children:[(0,t.jsx)("div",{className:i?"text-3xl":"text-6xl",children:{laptop:"💻",phone:"📱",car:"🚗",book:"📚",clothes:"👕",home:"🏠",health:"💄",sport:"⚽",toy:"🧸",industrial:"🏭",generic:"🛍️"}[s]}),!i&&(0,t.jsx)("p",{className:"mt-3 rounded-full bg-white/80 px-3 py-1 text-xs font-bold text-gray-600 shadow-sm",children:{laptop:"تصویر لپ‌تاپ",phone:"تصویر موبایل",car:"تصویر خودرو",book:"تصویر کتاب",clothes:"تصویر پوشاک",home:"تصویر کالای خانه",health:"تصویر سلامت",sport:"تصویر ورزشی",toy:"تصویر کودک",industrial:"تصویر صنعتی",generic:"تصویر کالا"}[s]})]})]})}e.s(["ProductHeroImage",0,function({images:e,title:i,category:s,className:l="aspect-square w-28 rounded-2xl"}){let o=e?.[0];return(0,t.jsx)("div",{className:`aspect-square overflow-hidden border border-gray-100 bg-white shadow-inner ${l}`,children:o?(0,t.jsx)("img",{src:(0,a.productImageUrl)(o),alt:`عکس محصول ${i}`,className:"h-full w-full object-contain p-1.5 transition duration-300 group-hover:scale-105",loading:"lazy"}):(0,t.jsx)(r,{title:i,category:s,compact:!0})})},"ProductImageStrip",0,function({images:e,title:r,label:i="عکس‌های محصول",emptyText:s}){return e&&0!==e.length?(0,t.jsxs)("div",{className:"mt-4 rounded-2xl border border-gray-100 bg-gray-50 p-4",children:[(0,t.jsxs)("div",{className:"mb-3 flex items-center justify-between gap-3",children:[(0,t.jsx)("h3",{className:"font-bold text-gray-900",children:i}),(0,t.jsxs)("span",{className:"rounded-full bg-white px-3 py-1 text-xs font-bold text-gray-500",children:[e.length.toLocaleString("fa-IR")," عکس"]})]}),(0,t.jsx)("div",{className:"grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4",children:e.map(e=>(0,t.jsxs)("a",{href:(0,a.productImageUrl)(e),target:"_blank",rel:"noreferrer",className:"group overflow-hidden rounded-2xl border border-white bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md",children:[(0,t.jsx)("div",{className:"aspect-square overflow-hidden bg-gray-100",children:(0,t.jsx)("img",{src:(0,a.productImageUrl)(e),alt:`${r} - ${e.originalName}`,className:"h-full w-full object-cover transition duration-300 group-hover:scale-105",loading:"lazy"})}),(0,t.jsxs)("p",{className:"truncate px-3 py-2 text-xs text-gray-500",children:["seller"===e.uploadedByRole?"فروشنده":"buyer"===e.uploadedByRole?"خریدار":"محصول"," ","· ",e.originalName]})]},e.id||e.storedName))})]}):s?(0,t.jsx)("div",{className:"rounded-2xl border border-dashed border-gray-200 bg-gray-50 p-4 text-sm text-gray-500",children:s}):null},"ProductThumb",0,function({images:e,title:i,category:s,className:l="h-20 w-20"}){let o=e?.[0];return(0,t.jsx)("div",{className:`shrink-0 overflow-hidden rounded-2xl border border-gray-200 bg-gray-100 ${l}`,children:o?(0,t.jsx)("img",{src:(0,a.productImageUrl)(o),alt:`عکس محصول ${i}`,className:"h-full w-full object-contain p-1",loading:"lazy"}):(0,t.jsx)(r,{title:i,category:s,compact:!0})})}])},73846,e=>{"use strict";var t=e.i(43476),a=e.i(71645);e.s(["default",0,function({sellerId:e,sellerName:r,sellerPhone:i,sellerEmail:s,requestId:l,requestTitle:o,requestBuyerId:n,compact:d=!1,className:c=""}){let[p,m]=(0,a.useState)(null),[x,b]=(0,a.useState)(0),[g,h]=(0,a.useState)(!1),[u,f]=(0,a.useState)(!1),[v,w]=(0,a.useState)(""),y=(0,a.useMemo)(()=>String(i||"").trim(),[i]),j=(0,a.useMemo)(()=>{let e;return!(e=String(s||"").trim())||e.includes("@phone.optibid.local")?"":e},[s]),N=!!(y||j);(0,a.useEffect)(()=>{m(localStorage.getItem("userRole")),b(Number(localStorage.getItem("userId")||0))},[]);let k=()=>!!(x||(sessionStorage.setItem("redirectAfterAuth",`${window.location.pathname}${window.location.search}`),window.location.href="/login",0))&&!!(!n||x===n||(alert("برای حفظ حریم خصوصی فروشنده، اطلاعات تماس و شروع ارتباط فقط برای خریدار صاحب همین درخواست فعال است."),0))&&("admin"!==p||(alert("ادمین برای ارتباط با فروشنده باید با حساب خریدار/فروشنده وارد شود."),!1)),$=async()=>{if(k()&&!u){f(!0),w("");try{let t=o?`برای درخواست \xab${o}\xbb${l?` (کد ${l})`:""}`:`برای پروفایل فروشنده \xab${r}\xbb`,a=await fetch("/api/messages",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({senderId:x,receiverId:e,content:`درخواست تماس امن از طریق OptiBid ${t}. لطفاً بدون نمایش شماره تلفن، زمان و روش هماهنگی را در چت OptiBid اعلام کنید.`})}),i=await a.json();if(!i.success)throw Error(i.message||"ارسال درخواست تماس ناموفق بود.");w("درخواست تماس امن برای فروشنده ارسال شد؛ پاسخ فروشنده در پیام‌های OptiBid نمایش داده می‌شود.")}catch(e){alert(e instanceof Error?e.message:"ارسال درخواست تماس از طریق OptiBid ناموفق بود.")}finally{f(!1)}}};return(0,t.jsxs)("div",{className:`${d?"rounded-3xl border border-sky-100 bg-gradient-to-l from-sky-50/90 to-white p-4 shadow-sm":"rounded-3xl border border-sky-100 bg-white p-6 shadow-sm"} ${c}`,dir:"rtl",children:[(0,t.jsxs)("div",{className:"mb-4 flex flex-col justify-between gap-3 md:flex-row md:items-start",children:[(0,t.jsxs)("div",{className:"min-w-0",children:[(0,t.jsx)("p",{className:"text-sm font-black text-[#003b5c]",children:"راه‌های ارتباط با فروشنده"}),(0,t.jsx)("p",{className:"mt-1 text-xs leading-6 text-slate-600",children:"خریدار می‌تواند مستقیم، بدون نمایش شماره یا با چت داخلی OptiBid هماهنگ کند."})]}),(0,t.jsx)("span",{className:"w-fit shrink-0 rounded-full bg-emerald-50 px-3 py-1 text-xs font-black text-emerald-700",children:"هر ۳ گزینه فعال"})]}),(0,t.jsxs)("div",{className:"grid gap-3 md:grid-cols-3",children:[(0,t.jsxs)("button",{type:"button",onClick:()=>{k()&&(w(""),h(e=>!e))},className:"flex min-h-24 items-center gap-3 rounded-2xl border border-emerald-200 bg-white px-4 py-3 text-right text-xs font-bold text-emerald-800 shadow-sm transition hover:-translate-y-0.5 hover:border-emerald-400 hover:bg-emerald-50",children:[(0,t.jsx)("span",{className:"grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-emerald-50 text-lg",children:"📞"}),(0,t.jsxs)("span",{className:"min-w-0",children:[(0,t.jsx)("span",{className:"block",children:"اطلاعات تماس فروشنده"}),(0,t.jsx)("span",{className:"mt-1 block font-normal leading-5 text-emerald-700/80",children:N?"شماره/ایمیل مستقیم":"در انتظار تکمیل پروفایل"})]})]}),(0,t.jsxs)("button",{type:"button",onClick:$,disabled:u,className:"flex min-h-24 items-center gap-3 rounded-2xl border border-blue-200 bg-white px-4 py-3 text-right text-xs font-bold text-blue-800 shadow-sm transition hover:-translate-y-0.5 hover:border-blue-400 hover:bg-blue-50 disabled:cursor-wait disabled:opacity-60",children:[(0,t.jsx)("span",{className:"grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-blue-50 text-lg",children:"☎️"}),(0,t.jsxs)("span",{className:"min-w-0",children:[(0,t.jsx)("span",{className:"block",children:"تماس از طریق OptiBid"}),(0,t.jsx)("span",{className:"mt-1 block font-normal leading-5 text-blue-700/80",children:u?"در حال ارسال درخواست...":"بدون نمایش شماره"})]})]}),(0,t.jsxs)("button",{type:"button",onClick:()=>{if(!k())return;sessionStorage.setItem("optibidChatTargetId",String(e)),sessionStorage.setItem("optibidChatTargetName",r);let t=new URLSearchParams({tab:"messages",chatWith:String(e),chatName:r});window.location.href=`/buyer/dashboard?${t.toString()}`},className:"flex min-h-24 items-center gap-3 rounded-2xl border border-violet-200 bg-white px-4 py-3 text-right text-xs font-bold text-violet-800 shadow-sm transition hover:-translate-y-0.5 hover:border-violet-400 hover:bg-violet-50",children:[(0,t.jsx)("span",{className:"grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-violet-50 text-lg",children:"💬"}),(0,t.jsxs)("span",{className:"min-w-0",children:[(0,t.jsx)("span",{className:"block",children:"چت از طریق OptiBid"}),(0,t.jsx)("span",{className:"mt-1 block font-normal leading-5 text-violet-700/80",children:"گفتگو داخل داشبورد"})]})]})]}),g&&(0,t.jsxs)("div",{className:"mt-3 rounded-2xl border border-emerald-100 bg-white p-4 text-sm leading-7 text-slate-700",children:[N?(0,t.jsxs)("div",{className:"space-y-2",children:[(0,t.jsxs)("p",{className:"font-bold text-emerald-800",children:["اطلاعات تماس مستقیم ",r]}),y&&(0,t.jsxs)("a",{href:`tel:${y.replace(/\s+/g,"")}`,className:"flex flex-wrap items-center justify-between gap-2 rounded-xl bg-emerald-50 px-3 py-2 font-bold text-emerald-800",dir:"ltr",children:[(0,t.jsx)("span",{children:y}),(0,t.jsx)("span",{dir:"rtl",children:"تماس تلفنی"})]}),j&&(0,t.jsxs)("a",{href:`mailto:${j}`,className:"flex flex-wrap items-center justify-between gap-2 rounded-xl bg-slate-50 px-3 py-2 font-bold text-slate-700",dir:"ltr",children:[(0,t.jsx)("span",{children:j}),(0,t.jsx)("span",{dir:"rtl",children:"ارسال ایمیل"})]})]}):(0,t.jsx)("p",{className:"text-amber-700",children:"فروشنده هنوز شماره یا ایمیل مستقیم را در پروفایل ثبت نکرده است؛ از «تماس از طریق OptiBid» یا «چت از طریق OptiBid» استفاده کنید."}),(0,t.jsx)("p",{className:"mt-3 text-xs leading-6 text-slate-500",children:"برای فروشنده‌هایی که نمی‌خواهند شماره‌شان عمومی شود، دو مسیر امن OptiBid فعال است و شماره طرفین نمایش داده نمی‌شود."})]}),v&&(0,t.jsx)("p",{className:"mt-3 rounded-2xl border border-emerald-100 bg-emerald-50 px-4 py-3 text-xs font-bold leading-6 text-emerald-800",children:v})]})}])},11777,e=>{"use strict";var t=e.i(43476);let a={sm:"text-sm",md:"text-lg",lg:"text-2xl"};e.s(["default",0,function({score:e,size:r="md",showLabel:i=!0,light:s=!1,className:l=""}){let o=Math.max(0,Math.min(5,e/20)),n=Math.round(o);return(0,t.jsxs)("div",{className:`inline-flex items-center gap-1.5 ${l}`,"aria-label":`امتیاز ${o.toFixed(1)} از ۵`,children:[(0,t.jsx)("span",{className:`tracking-tight text-amber-400 ${a[r]}`,"aria-hidden":"true",children:Array.from({length:5},(e,t)=>t<n?"★":"☆").join("")}),i&&(0,t.jsxs)("span",{className:`font-bold ${s?"text-white":"text-[#003b5c]"}`,children:[o.toLocaleString("fa-IR",{minimumFractionDigits:1,maximumFractionDigits:1}),(0,t.jsx)("span",{className:`mr-0.5 text-xs font-normal ${s?"text-blue-100":"text-gray-500"}`,children:"از ۵"})]})]})}])},59411,e=>{"use strict";var t=e.i(43476),a=e.i(71645);let r={buyer:[["quality","کیفیت و سلامت کالا"],["match","تطابق کالا با پیشنهاد"],["shipping","سرعت و تعهد در ارسال"],["packaging","بسته‌بندی و تحویل"],["communication","پاسخ‌گویی و رفتار فروشنده"]],seller:[["clarity","شفافیت و دقت درخواست"],["cooperation","همکاری در فرایند معامله"],["communication","ارتباط و پاسخ‌گویی خریدار"],["receipt","سرعت بررسی و تایید دریافت"],["conduct","رفتار حرفه‌ای در معامله"]]};function i({value:e,onChange:a}){return(0,t.jsx)("div",{className:"flex gap-1",dir:"ltr",children:[1,2,3,4,5].map(r=>{let i=r<=e;return(0,t.jsx)("button",{type:"button",onClick:()=>a(r),className:`text-3xl transition hover:scale-110 ${i?"text-amber-400":"text-gray-300 hover:text-amber-300"}`,"aria-label":`${r} ستاره`,children:i?"★":"☆"},r)})})}e.s(["default",0,function({role:e,reviewerId:s,order:l,onSaved:o}){let n=r[e],[d,c]=(0,a.useState)(Object.fromEntries(n.map(([e])=>[e,0]))),[p,m]=(0,a.useState)(""),[x,b]=(0,a.useState)(!1),g=Object.values(d).filter(e=>e>0),h=g.length===n.length,u=h?Math.round(g.reduce((e,t)=>e+t,0)/g.length):0,f="buyer"===e?l.sellerName:l.buyerName,v=async()=>{if(!h)return void alert("لطفاً برای همه معیارهای نظرسنجی امتیاز ستاره‌ای ثبت کنید.");b(!0);try{let e=await fetch("/api/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({orderId:l.id,reviewerId:s,overall:u,scores:d,comment:p})}),t=await e.json();if(!t.success)throw Error(t.message);alert(t.message),await o()}catch(e){alert(e instanceof Error?e.message:"ثبت نظرسنجی ناموفق بود.")}finally{b(!1)}};return(0,t.jsxs)("article",{className:"rounded-3xl border border-gray-200 bg-white p-6 shadow-sm",children:[(0,t.jsxs)("div",{className:"mb-5 flex flex-col justify-between gap-3 sm:flex-row sm:items-center",children:[(0,t.jsxs)("div",{children:[(0,t.jsxs)("p",{className:"text-xs font-bold text-[#00a8e8]",children:["سفارش ",l.id]}),(0,t.jsxs)("h3",{className:"mt-1 text-lg font-bold text-[#003b5c]",children:["ارزیابی ",f]}),(0,t.jsx)("p",{className:"mt-1 text-sm text-gray-500",children:l.title})]}),(0,t.jsxs)("div",{className:"rounded-xl bg-amber-50 px-4 py-2 text-center",children:[(0,t.jsxs)("p",{className:"text-2xl text-amber-400",children:["★".repeat(u),"☆".repeat(5-u)]}),(0,t.jsx)("p",{className:"text-xs font-bold text-amber-800",children:h?`امتیاز نهایی ${u} از ۵`:"هنوز امتیازی ثبت نشده"})]})]}),(0,t.jsx)("div",{className:"space-y-3 border-y border-gray-100 py-5",children:n.map(([e,a])=>(0,t.jsxs)("div",{className:"flex flex-col justify-between gap-2 rounded-xl bg-gray-50 px-4 py-3 sm:flex-row sm:items-center",children:[(0,t.jsx)("span",{className:"text-sm font-bold text-gray-700",children:a}),(0,t.jsx)(i,{value:d[e],onChange:t=>c({...d,[e]:t})})]},e))}),(0,t.jsx)("label",{className:"mt-5 block text-sm font-bold text-gray-700",children:"توضیحات شما (اختیاری)"}),(0,t.jsx)("textarea",{value:p,onChange:e=>m(e.target.value),placeholder:"تجربه واقعی خود از این معامله را بنویسید...",className:"mt-2 min-h-24 w-full rounded-xl border border-gray-200 p-3 text-sm outline-none focus:border-[#00a8e8]"}),(0,t.jsx)("p",{className:"mt-2 text-xs leading-6 text-gray-500",children:"متن این بخش دقیقاً در قسمت «دیدگاه‌ها» صفحه طرف مقابل نمایش داده می‌شود."}),(0,t.jsx)("button",{type:"button",disabled:x||!h,onClick:v,className:"mt-4 rounded-xl bg-[#003b5c] px-6 py-3 text-sm font-bold text-white transition hover:bg-[#002d46] disabled:bg-gray-400",children:x?"در حال ثبت...":"ثبت نهایی امتیاز و نظر"})]})}])},56722,e=>{"use strict";var t=e.i(19614);function a(e){return"number"==typeof e?Math.max(0,Math.round(e)):Math.max(0,Number(String(e||"").replace(/[۰-۹]/g,e=>String("۰۱۲۳۴۵۶۷۸۹".indexOf(e))).replace(/[٠-٩]/g,e=>String("٠١٢٣٤٥٦٧٨٩".indexOf(e))).replace(/\D/g,""))||0)}function r(e){let t=a(e);return t?`${t.toLocaleString("fa-IR")} تومان`:"۰ تومان"}function i(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function s(e,t){return t?`<div class="spec-row"><span>${i(e)}</span><b>${i(t)}</b></div>`:""}e.s(["generateInvoiceHTML",0,e=>{var l;let o=(0,t.getCachedLiveContent)(),n=e.id||e.orderId||`INV-${Date.now()}`,d=e.date||new Date().toLocaleDateString("fa-IR"),c=e.sellerName||e.seller||"فروشنده OptiBid",p=e.buyerName||e.buyer||"خریدار OptiBid",m=e.product||e.title||"کالای مورد معامله",x=e.description||e.productDescription||"",b=e.category||"کالا / خدمات",g=Math.max(1,Number(e.quantity||1)||1),h=a(e.totalAmount??e.amount),u=a(e.unitAmount)||Math.round(h/g),f=a(e.platformFee),v=a(e.sellerAmount)||Math.max(0,h-f),w=a(e.taxAmount),y=a(e.shippingAmount),j=h+w+y,N=e.productSpecs||{},k=`https://optibid.fazilat-ma.workers.dev/verify/${encodeURIComponent(n)}`,$=N.brand||e.brand||"—",S=[N.exactModel,N.cpu,N.ram,N.storage].filter(Boolean).join(" · "),z=[s("برند",N.brand),s("مدل دقیق",N.exactModel),s("کد مدل / کانفیگ",N.serialOrConfig),s("پردازنده",N.cpu),s("رم",N.ram),s("حافظه",N.storage),s("گرافیک",N.gpu),s("نمایشگر",N.display),s("سال ساخت",N.manufactureYear),s("وضعیت کالا",N.productCondition),s("گارانتی",N.warrantyStatus),s("سلامت کلی قطعات",N.partsHealth),s("سلامت باتری",N.batteryHealthPercent?`${N.batteryHealthPercent}%`:""),s("گرید ظاهری",N.appearanceGrade),s("سابقه تعمیر",N.repairHistory),s("مهلت تست",N.testDeadlineDays?`${N.testDeadlineDays} روز`:"")].filter(Boolean).join("");return`<!DOCTYPE html>
    ...
    <section class="content">
      <header class="header">
        ...
        <div class="meta">
          ...
          <div class="meta-row"><span>وضعیت / Status</span><b>${i({pending_payment:"در انتظار پرداخت",paid:"پرداخت‌شده و آماده ارسال",shipped:"ارسال‌شده",completed:"تکمیل‌شده",cancelled:"لغوشده",returned:"مرجوع‌شده"}[(l=e.status)||""]||l||"ثبت‌شده")}</b></div>
      ...
      <section class="party-grid">
        <article class="party-card">
          ...
          <div class="info-row"><span>آدرس</span><b>${i(o.invoiceCompanyAddressFa)}</b></div>
        ...
        <article class="party-card">
          ...
          <div class="info-row"><span>آدرس تحویل</span><b>${i(e.shippingAddress||o.invoiceShippingAddressFa)}</b></div>
          ...
          <tbody>
            <tr>
              ...
              <td class="item">
                <b>${i(m)}</b>
                ${S?`<small>${i(S)}</small>`:""}
                ${x?`<div style="font-size:10px;color:#64748b;margin-top:5px">${i(x).slice(0,180)}</div>`:""}
