          ...
          <tbody>
            <tr>
              ...
              <td class="item">
                <b>${r(m)}</b>
                ${z?`<small>${r(z)}</small>`:""}
                ${b?`<div style="font-size:10px;color:#64748b;margin-top:5px">${r(b).slice(0,180)}</div>`:""}
