...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let ra = ["/login", "/register", "/forgot-password"], ro = ["/api/login", "/api/register", "/api/logout", "/api/auth/social", "/api/password", "/api/live-content", "/api/health"];
      function rs() {
