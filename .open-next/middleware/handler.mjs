...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let ra = ["/login", "/register", "/forgot-password", "/shop", "/cart"], ro = ["/api/login", "/api/register", "/api/logout", "/api/auth/social", "/api/password", "/api/live-content", "/api/catalog-categories", "/api/site-mode", "/api/health"];
      function rs() {
