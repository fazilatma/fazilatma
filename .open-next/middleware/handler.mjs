...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      async function tx(t10) {
        ...
        if (s2 && O2 && !p2) {
          let e10 = new $(O2, { forceLocale: false, headers: t10.request.headers, nextConfig: t10.request.nextConfig });
      ...
      let ra = ["/login", "/register", "/forgot-password", "/shop", "/cart", "/support"], ro = ["/api/login", "/api/register", "/api/logout", "/api/auth/social", "/api/password", "/api/live-content", "/api/catalog-categories", "/api/site-mode", "/api/support-chat", "/api/health"];
      function rs() {
        return es.json({ success: false, message: "\u0628\u0631\u0627\u06CC \u062F\u0633\u062A\u0631\u0633\u06CC \u0628\u0647 \u0627\u06CC\u0646 \u0628\u062E\u0634 \u0628\u0627\u06CC\u062F \u0627\u0628\u062A\u062F\u0627 \u062B\u0628\u062A\u200C\u0646\u0627\u0645 \u0648 \u0648\u0631\u0648\u062F \u06A9\u0646\u06CC\u062F." }, { status: 401 });
      }
      e.s(["config", 0, { matcher: ["/((?!_next/static|_next/image|favicon.ico|.*\\..*).*)"] }, "middleware", 0, function(e10) {
        let t10 = e10.nextUrl.pathname;
        if ("www.optibid.ir" === (e10.headers.get("host") || "").toLowerCase()) {
          let t11 = e10.nextUrl.clone();
          return t11.hostname = "optibid.ir", t11.protocol = "https", t11.port = "", es.redirect(t11, 308);
        }
        if ("/" === t10 || t10.startsWith("/_next") || "/favicon.ico" === t10 || ra.some((e11) => t10 === e11 || t10.startsWith(`${e11}/`)) || ro.some((e11) => t10 === e11 || t10.startsWith(`${e11}/`))) return es.next();
        let r2 = e10.cookies.get("optibid_admin")?.value === "1", n2 = !!e10.cookies.get("optibid_user")?.value;
        if (t10.startsWith("/admin") || t10.startsWith("/api/admin")) {
          if (!r2) {
            if (t10.startsWith("/api/")) return rs();
            let r3 = new URL("/login", e10.url);
            return r3.searchParams.set("next", t10), es.redirect(r3);
          }
          return es.next();
        }
        if (!n2 && !r2) {
          if (t10.startsWith("/api/")) return rs();
          let r3 = new URL("/login", e10.url);
          return r3.searchParams.set("next", `${t10}${e10.nextUrl.search}`), es.redirect(r3);
        }
        return es.next();
      }], 96592);
      let rl = { ...e.i(96592) }, ru = "/middleware", rc = rl.middleware || rl.default;
      if ("function" != typeof rc) throw new class extends Error {
        constructor(e10) {
          super(e10), this.stack = "";
        }
      }(`The Middleware file "${ru}" must export a function named \`middleware\` or a default function.`);
      let rd = (e10) => tx({ ...e10, IncrementalCache: ri, incrementalCacheHandler: null, page: ru, handler: async (...e11) => {
        try {
          return await rc(...e11);
        } catch (i2) {
      ...
      async function rh(e10, t10) {
        let r2 = await rd({ request: { url: e10.url, method: e10.method, headers: w(e10.headers), nextConfig: { basePath: "", i18n: "", trailingSlash: false, experimental: { cacheLife: { default: { stale: 300, revalidate: 900, expire: 4294967294 }, seconds: { stale: 30, revalidate: 1, expire: 60 }, minutes: { stale: 300, revalidate: 60, expire: 3600 }, hours: { stale: 300, revalidate: 3600, expire: 86400 }, days: { stale: 300, revalidate: 86400, expire: 604800 }, weeks: { stale: 300, revalidate: 604800, expire: 2592e3 }, max: { stale: 300, revalidate: 2592e3, expire: 31536e3 } }, authInterrupts: false, clientParamParsingOrigins: [] } }, page: { name: ru }, body: "GET" !== e10.method && "HEAD" !== e10.method ? e10.body ?? void 0 : void 0, waitUntil: t10.waitUntil, requestMeta: t10.requestMeta, signal: t10.signal || new AbortController().signal } });
        return null == t10.waitUntil || t10.waitUntil.call(t10, r2.waitUntil), r2.response;
      }
      e.s(["default", 0, rd, "handler", 0, rh], 58217);
    }]);
  }
});
...
var NextConfig = { "env": {}, "webpack": null, "typescript": { "ignoreBuildErrors": false }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": false, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 14400, "formats": ["image/webp"], "maximumRedirects": 3, "maximumResponseBody": 5e7, "dangerouslyAllowLocalIP": false, "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "localPatterns": [{ "pathname": "**", "search": "" }], "remotePatterns": [], "qualities": [75], "unoptimized": false, "customCacheHandler": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": { "serverFunctions": true, "browserToTerminal": "warn" }, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "/home/user/fazilatma", "cacheComponents": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 31536e3 } }, "cacheHandlers": {}, "experimental": { "appNewScrollHandler": false, "useSkewCookie": false, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "cachedNavigations": false, "partialFallbacks": false, "dynamicOnHover": false, "varyParams": false, "prefetchInlining": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "proxyPrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 1, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "strictRouteTypes": false, "useTypeScriptCli": false, "viewTransition": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "reactDebugChannel": true, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "transitionIndicator": false, "gestureTransition": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "browserDebugInfoInTerminal": "warn", "lockDistDir": true, "proxyClientMaxBodySize": 10485760, "hideLogsAfterAbort": false, "mcpServer": true, "turbopackFileSystemCacheForDev": true, "turbopackFileSystemCacheForBuild": false, "turbopackInferModuleSideEffects": true, "turbopackPluginRuntimeStrategy": "childProcesses", "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts", "turbopack": { "root": "/home/user/fazilatma" }, "distDirRoot": ".next" };
var BuildId = "2jmoEGdofioxKyhpC2-IX";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "priority": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_global-error", "regex": "^/_global\\-error(?:/)?$", "routeKeys": {}, "namedRegex": "^/_global\\-error(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/account/completion", "regex": "^/account/completion(?:/)?$", "routeKeys": {}, "namedRegex": "^/account/completion(?:/)?$" }, { "page": "/admin/dashboard", "regex": "^/admin/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/dashboard(?:/)?$" }, { "page": "/api/account/seller-mode", "regex": "^/api/account/seller\\-mode(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/account/seller\\-mode(?:/)?$" }, { "page": "/api/admin/categories", "regex": "^/api/admin/categories(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/categories(?:/)?$" }, { "page": "/api/admin/finance", "regex": "^/api/admin/finance(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/finance(?:/)?$" }, { "page": "/api/admin/homepage-slider", "regex": "^/api/admin/homepage\\-slider(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/homepage\\-slider(?:/)?$" }, { "page": "/api/admin/kyc", "regex": "^/api/admin/kyc(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/kyc(?:/)?$" }, { "page": "/api/admin/kyc-document", "regex": "^/api/admin/kyc\\-document(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/kyc\\-document(?:/)?$" }, { "page": "/api/admin/seller-metrics", "regex": "^/api/admin/seller\\-metrics(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/seller\\-metrics(?:/)?$" }, { "page": "/api/admin/store-products/import", "regex": "^/api/admin/store\\-products/import(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/store\\-products/import(?:/)?$" }, { "page": "/api/admin/store-products/refresh-prices", "regex": "^/api/admin/store\\-products/refresh\\-prices(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/store\\-products/refresh\\-prices(?:/)?$" }, { "page": "/api/admin/storefront-slider", "regex": "^/api/admin/storefront\\-slider(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/storefront\\-slider(?:/)?$" }, { "page": "/api/admin/users", "regex": "^/api/admin/users(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/users(?:/)?$" }, { "page": "/api/admin/withdrawals", "regex": "^/api/admin/withdrawals(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/withdrawals(?:/)?$" }, { "page": "/api/avatar", "regex": "^/api/avatar(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/avatar(?:/)?$" }, { "page": "/api/buyer/profile", "regex": "^/api/buyer/profile(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/buyer/profile(?:/)?$" }, { "page": "/api/catalog-categories", "regex": "^/api/catalog\\-categories(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/catalog\\-categories(?:/)?$" }, { "page": "/api/dashboard/buyer", "regex": "^/api/dashboard/buyer(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/dashboard/buyer(?:/)?$" }, { "page": "/api/dashboard/seller", "regex": "^/api/dashboard/seller(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/dashboard/seller(?:/)?$" }, { "page": "/api/database-status", "regex": "^/api/database\\-status(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/database\\-status(?:/)?$" }, { "page": "/api/download-source", "regex": "^/api/download\\-source(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/download\\-source(?:/)?$" }, { "page": "/api/external-link", "regex": "^/api/external\\-link(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/external\\-link(?:/)?$" }, { "page": "/api/health", "regex": "^/api/health(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/health(?:/)?$" }, { "page": "/api/live-content", "regex": "^/api/live\\-content(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/live\\-content(?:/)?$" }, { "page": "/api/login", "regex": "^/api/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/login(?:/)?$" }, { "page": "/api/logout", "regex": "^/api/logout(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/logout(?:/)?$" }, { "page": "/api/messages", "regex": "^/api/messages(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/messages(?:/)?$" }, { "page": "/api/orders/archive", "regex": "^/api/orders/archive(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/orders/archive(?:/)?$" }, { "page": "/api/orders/cancel", "regex": "^/api/orders/cancel(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/orders/cancel(?:/)?$" }, { "page": "/api/orders/confirm-received", "regex": "^/api/orders/confirm\\-received(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/orders/confirm\\-received(?:/)?$" }, { "page": "/api/orders/pay", "regex": "^/api/orders/pay(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/orders/pay(?:/)?$" }, { "page": "/api/orders/select-offer", "regex": "^/api/orders/select\\-offer(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/orders/select\\-offer(?:/)?$" }, { "page": "/api/orders/ship", "regex": "^/api/orders/ship(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/orders/ship(?:/)?$" }, { "page": "/api/password/forgot", "regex": "^/api/password/forgot(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/password/forgot(?:/)?$" }, { "page": "/api/password/reset", "regex": "^/api/password/reset(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/password/reset(?:/)?$" }, { "page": "/api/payments/zarinpal/callback", "regex": "^/api/payments/zarinpal/callback(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/payments/zarinpal/callback(?:/)?$" }, { "page": "/api/product-image", "regex": "^/api/product\\-image(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/product\\-image(?:/)?$" }, { "page": "/api/register", "regex": "^/api/register(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/register(?:/)?$" }, { "page": "/api/reviews", "regex": "^/api/reviews(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/reviews(?:/)?$" }, { "page": "/api/seller/profile", "regex": "^/api/seller/profile(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/seller/profile(?:/)?$" }, { "page": "/api/seller-matching-requests", "regex": "^/api/seller\\-matching\\-requests(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/seller\\-matching\\-requests(?:/)?$" }, { "page": "/api/seller-performance-event", "regex": "^/api/seller\\-performance\\-event(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/seller\\-performance\\-event(?:/)?$" }, { "page": "/api/seller-request-action", "regex": "^/api/seller\\-request\\-action(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/seller\\-request\\-action(?:/)?$" }, { "page": "/api/seller-score", "regex": "^/api/seller\\-score(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/seller\\-score(?:/)?$" }, { "page": "/api/shop/orders", "regex": "^/api/shop/orders(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/shop/orders(?:/)?$" }, { "page": "/api/shop/orders/pay", "regex": "^/api/shop/orders/pay(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/shop/orders/pay(?:/)?$" }, { "page": "/api/site-mode", "regex": "^/api/site\\-mode(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/site\\-mode(?:/)?$" }, { "page": "/api/source-files", "regex": "^/api/source\\-files(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/source\\-files(?:/)?$" }, { "page": "/api/submit-offer", "regex": "^/api/submit\\-offer(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/submit\\-offer(?:/)?$" }, { "page": "/api/submit-request", "regex": "^/api/submit\\-request(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/submit\\-request(?:/)?$" }, { "page": "/api/support-chat", "regex": "^/api/support\\-chat(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/support\\-chat(?:/)?$" }, { "page": "/api/wallet/topup", "regex": "^/api/wallet/topup(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/wallet/topup(?:/)?$" }, { "page": "/api/wallet/withdraw", "regex": "^/api/wallet/withdraw(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/wallet/withdraw(?:/)?$" }, { "page": "/become-seller", "regex": "^/become\\-seller(?:/)?$", "routeKeys": {}, "namedRegex": "^/become\\-seller(?:/)?$" }, { "page": "/buyer/dashboard", "regex": "^/buyer/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/buyer/dashboard(?:/)?$" }, { "page": "/buyers", "regex": "^/buyers(?:/)?$", "routeKeys": {}, "namedRegex": "^/buyers(?:/)?$" }, { "page": "/cart", "regex": "^/cart(?:/)?$", "routeKeys": {}, "namedRegex": "^/cart(?:/)?$" }, { "page": "/categories", "regex": "^/categories(?:/)?$", "routeKeys": {}, "namedRegex": "^/categories(?:/)?$" }, { "page": "/contact", "regex": "^/contact(?:/)?$", "routeKeys": {}, "namedRegex": "^/contact(?:/)?$" }, { "page": "/external-link", "regex": "^/external\\-link(?:/)?$", "routeKeys": {}, "namedRegex": "^/external\\-link(?:/)?$" }, { "page": "/forgot-password", "regex": "^/forgot\\-password(?:/)?$", "routeKeys": {}, "namedRegex": "^/forgot\\-password(?:/)?$" }, { "page": "/how-it-works", "regex": "^/how\\-it\\-works(?:/)?$", "routeKeys": {}, "namedRegex": "^/how\\-it\\-works(?:/)?$" }, { "page": "/login", "regex": "^/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/login(?:/)?$" }, { "page": "/manifest.webmanifest", "regex": "^/manifest\\.webmanifest(?:/)?$", "routeKeys": {}, "namedRegex": "^/manifest\\.webmanifest(?:/)?$" }, { "page": "/register", "regex": "^/register(?:/)?$", "routeKeys": {}, "namedRegex": "^/register(?:/)?$" }, { "page": "/request-board", "regex": "^/request\\-board(?:/)?$", "routeKeys": {}, "namedRegex": "^/request\\-board(?:/)?$" }, { "page": "/request-purchase", "regex": "^/request\\-purchase(?:/)?$", "routeKeys": {}, "namedRegex": "^/request\\-purchase(?:/)?$" }, { "page": "/requests", "regex": "^/requests(?:/)?$", "routeKeys": {}, "namedRegex": "^/requests(?:/)?$" }, { "page": "/robots.txt", "regex": "^/robots\\.txt(?:/)?$", "routeKeys": {}, "namedRegex": "^/robots\\.txt(?:/)?$" }, { "page": "/seller/dashboard", "regex": "^/seller/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/seller/dashboard(?:/)?$" }, { "page": "/seller/sales", "regex": "^/seller/sales(?:/)?$", "routeKeys": {}, "namedRegex": "^/seller/sales(?:/)?$" }, { "page": "/sellers", "regex": "^/sellers(?:/)?$", "routeKeys": {}, "namedRegex": "^/sellers(?:/)?$" }, { "page": "/shop", "regex": "^/shop(?:/)?$", "routeKeys": {}, "namedRegex": "^/shop(?:/)?$" }, { "page": "/shop/collections", "regex": "^/shop/collections(?:/)?$", "routeKeys": {}, "namedRegex": "^/shop/collections(?:/)?$" }, { "page": "/shop/guides", "regex": "^/shop/guides(?:/)?$", "routeKeys": {}, "namedRegex": "^/shop/guides(?:/)?$" }, { "page": "/sitemap.xml", "regex": "^/sitemap\\.xml(?:/)?$", "routeKeys": {}, "namedRegex": "^/sitemap\\.xml(?:/)?$" }, { "page": "/source-code", "regex": "^/source\\-code(?:/)?$", "routeKeys": {}, "namedRegex": "^/source\\-code(?:/)?$" }, { "page": "/support", "regex": "^/support(?:/)?$", "routeKeys": {}, "namedRegex": "^/support(?:/)?$" }], "dynamic": [{ "page": "/api/auth/social/[provider]", "regex": "^/api/auth/social/([^/]+?)(?:/)?$", "routeKeys": { "nxtPprovider": "nxtPprovider" }, "namedRegex": "^/api/auth/social/(?<nxtPprovider>[^/]+?)(?:/)?$" }, { "page": "/api/auth/social/[provider]/callback", "regex": "^/api/auth/social/([^/]+?)/callback(?:/)?$", "routeKeys": { "nxtPprovider": "nxtPprovider" }, "namedRegex": "^/api/auth/social/(?<nxtPprovider>[^/]+?)/callback(?:/)?$" }, { "page": "/buyers/[id]", "regex": "^/buyers/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/buyers/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/categories/[id]", "regex": "^/categories/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/categories/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/requests/[id]", "regex": "^/requests/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/requests/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/requests/[id]/checkout", "regex": "^/requests/([^/]+?)/checkout(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/requests/(?<nxtPid>[^/]+?)/checkout(?:/)?$" }, { "page": "/requests/[id]/offer", "regex": "^/requests/([^/]+?)/offer(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/requests/(?<nxtPid>[^/]+?)/offer(?:/)?$" }, { "page": "/sellers/[id]", "regex": "^/sellers/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/sellers/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/shop/collections/[slug]", "regex": "^/shop/collections/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/shop/collections/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/shop/guides/[slug]", "regex": "^/shop/guides/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/shop/guides/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/shop/[slug]", "regex": "^/shop/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/shop/(?<nxtPslug>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [{ "source": "/_next/static/:path*", "headers": [{ "key": "Cache-Control", "value": "public, max-age=31536000, immutable" }], "regex": "^/_next/static(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/:path*.{png,jpg,jpeg,webp,svg,ico,css,js}", "headers": [{ "key": "Cache-Control", "value": "public, max-age=31536000, immutable" }], "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?\\.(?:png,jpg,jpeg,webp,svg,ico,css,js)(?:/)?$" }];
var PrerenderManifest = { "version": 4, "routes": { "/_global-error": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_global-error", "dataRoute": "/_global-error.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/manifest.webmanifest": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "application/manifest+json", "x-next-cache-tags": "_N_T_/layout,_N_T_/manifest.webmanifest/layout,_N_T_/manifest.webmanifest/route,_N_T_/manifest.webmanifest" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/manifest.webmanifest", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/robots.txt": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "text/plain", "x-next-cache-tags": "_N_T_/layout,_N_T_/robots.txt/layout,_N_T_/robots.txt/route,_N_T_/robots.txt" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/robots.txt", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "69478dedf4f6273e841d77b55fbf1a9c", "previewModeSigningKey": "b22961048241158a3e3aade3f698ac22f130d7f15649c5b097acad7737c15aad", "previewModeEncryptionKey": "7379abcf5a0d6bfeb904ef3dc1f7a40a00ff5154d613926f85f2cdd0337b9974" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge/chunks/node_modules_next_dist_esm_build_templates_edge-wrapper_0_kjzx3.js", "server/edge/chunks/[root-of-the-server]__0emy-m4._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0a9xbl8.js"], "name": "middleware", "page": "/", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0a9xbl8.js", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|.*\\..*).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico|.*\\..*).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "2jmoEGdofioxKyhpC2-IX", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "EhYY4NuDgEf8t0v8XXYgfuN9QP3UsJnFvpjItwxBpfI=", "__NEXT_PREVIEW_MODE_ID": "69478dedf4f6273e841d77b55fbf1a9c", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "7379abcf5a0d6bfeb904ef3dc1f7a40a00ff5154d613926f85f2cdd0337b9974", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "b22961048241158a3e3aade3f698ac22f130d7f15649c5b097acad7737c15aad" } } }, "sortedMiddleware": ["/"], "functions": {} };
var AppPathRoutesManifest = { "/_global-error/page": "/_global-error", "/_not-found/page": "/_not-found", "/account/completion/page": "/account/completion", "/admin/dashboard/page": "/admin/dashboard", "/api/account/seller-mode/route": "/api/account/seller-mode", "/api/admin/categories/route": "/api/admin/categories", "/api/admin/finance/route": "/api/admin/finance", "/api/admin/homepage-slider/route": "/api/admin/homepage-slider", "/api/admin/kyc-document/route": "/api/admin/kyc-document", "/api/admin/kyc/route": "/api/admin/kyc", "/api/admin/seller-metrics/route": "/api/admin/seller-metrics", "/api/admin/store-products/import/route": "/api/admin/store-products/import", "/api/admin/store-products/refresh-prices/route": "/api/admin/store-products/refresh-prices", "/api/admin/storefront-slider/route": "/api/admin/storefront-slider", "/api/admin/users/route": "/api/admin/users", "/api/admin/withdrawals/route": "/api/admin/withdrawals", "/api/auth/social/[provider]/callback/route": "/api/auth/social/[provider]/callback", "/api/auth/social/[provider]/route": "/api/auth/social/[provider]", "/api/avatar/route": "/api/avatar", "/api/buyer/profile/route": "/api/buyer/profile", "/api/catalog-categories/route": "/api/catalog-categories", "/api/dashboard/buyer/route": "/api/dashboard/buyer", "/api/dashboard/seller/route": "/api/dashboard/seller", "/api/database-status/route": "/api/database-status", "/api/download-source/route": "/api/download-source", "/api/external-link/route": "/api/external-link", "/api/health/route": "/api/health", "/api/live-content/route": "/api/live-content", "/api/login/route": "/api/login", "/api/logout/route": "/api/logout", "/api/messages/route": "/api/messages", "/api/orders/archive/route": "/api/orders/archive", "/api/orders/cancel/route": "/api/orders/cancel", "/api/orders/confirm-received/route": "/api/orders/confirm-received", "/api/orders/pay/route": "/api/orders/pay", "/api/orders/select-offer/route": "/api/orders/select-offer", "/api/orders/ship/route": "/api/orders/ship", "/api/password/forgot/route": "/api/password/forgot", "/api/password/reset/route": "/api/password/reset", "/api/payments/zarinpal/callback/route": "/api/payments/zarinpal/callback", "/api/product-image/route": "/api/product-image", "/api/register/route": "/api/register", "/api/reviews/route": "/api/reviews", "/api/seller-matching-requests/route": "/api/seller-matching-requests", "/api/seller-performance-event/route": "/api/seller-performance-event", "/api/seller-request-action/route": "/api/seller-request-action", "/api/seller-score/route": "/api/seller-score", "/api/seller/profile/route": "/api/seller/profile", "/api/shop/orders/pay/route": "/api/shop/orders/pay", "/api/shop/orders/route": "/api/shop/orders", "/api/site-mode/route": "/api/site-mode", "/api/source-files/route": "/api/source-files", "/api/submit-offer/route": "/api/submit-offer", "/api/submit-request/route": "/api/submit-request", "/api/support-chat/route": "/api/support-chat", "/api/wallet/topup/route": "/api/wallet/topup", "/api/wallet/withdraw/route": "/api/wallet/withdraw", "/become-seller/page": "/become-seller", "/buyer/dashboard/page": "/buyer/dashboard", "/buyers/[id]/page": "/buyers/[id]", "/buyers/page": "/buyers", "/cart/page": "/cart", "/categories/[id]/page": "/categories/[id]", "/categories/page": "/categories", "/contact/page": "/contact", "/external-link/page": "/external-link", "/forgot-password/page": "/forgot-password", "/how-it-works/page": "/how-it-works", "/login/page": "/login", "/manifest.webmanifest/route": "/manifest.webmanifest", "/page": "/", "/register/page": "/register", "/request-board/page": "/request-board", "/request-purchase/page": "/request-purchase", "/requests/[id]/checkout/page": "/requests/[id]/checkout", "/requests/[id]/offer/page": "/requests/[id]/offer", "/requests/[id]/page": "/requests/[id]", "/requests/page": "/requests", "/robots.txt/route": "/robots.txt", "/seller/dashboard/page": "/seller/dashboard", "/seller/sales/page": "/seller/sales", "/sellers/[id]/page": "/sellers/[id]", "/sellers/page": "/sellers", "/shop/[slug]/page": "/shop/[slug]", "/shop/collections/[slug]/page": "/shop/collections/[slug]", "/shop/collections/page": "/shop/collections", "/shop/guides/[slug]/page": "/shop/guides/[slug]", "/shop/guides/page": "/shop/guides", "/shop/page": "/shop", "/sitemap.xml/route": "/sitemap.xml", "/source-code/page": "/source-code", "/support/page": "/support" };
