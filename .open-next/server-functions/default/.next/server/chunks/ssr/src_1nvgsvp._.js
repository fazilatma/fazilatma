module.exports=[65893,a=>{"use strict";a.s(["productImageUrl",0,function(a){if(!a?.storedName)return"";let b=a.id||a.storedName;return`/api/product-image?name=${encodeURIComponent(a.storedName)}&v=${encodeURIComponent(b)}`}])},98649,a=>{"use strict";var b=a.i(87924),c=a.i(65893);function d({title:a,category:c,compact:e=!1}){let f=function(a,b=""){let c=`${a} ${b}`.toLowerCase();return/لپ|لب تاب|لپتاپ|laptop|notebook|thinkpad|vostro|latitude|dell|lenovo|asus|rog|hp|macbook|acer/.test(c)?"laptop":/موبایل|گوشی|mobile|phone|iphone|samsung|xiaomi|tablet|تبلت/.test(c)?"phone":/خودرو|ماشین|موتور|car|auto/.test(c)?"car":/کتاب|تحریر|book|stationery/.test(c)?"book":/پوشاک|لباس|کفش|مد|clothes|fashion/.test(c)?"clothes":/خانه|آشپزخانه|home|kitchen/.test(c)?"home":/زیبایی|سلامت|آرایشی|health|beauty/.test(c)?"health":/ورزش|سفر|sport|travel/.test(c)?"sport":/اسباب|کودک|toy|baby/.test(c)?"toy":/صنعتی|اداری|industrial|office/.test(c)?"industrial":/دیجیتال|digital|ssd|ram|cpu|gpu|monitor/.test(c)?"laptop":"generic"}(a,c);return"laptop"===f?(0,b.jsxs)("div",{className:"relative grid h-full w-full place-items-center overflow-hidden bg-white",children:[(0,b.jsx)("div",{className:"absolute inset-0 bg-gradient-to-br from-sky-50 via-white to-emerald-50"}),(0,b.jsxs)("div",{className:"relative flex h-[88%] w-[88%] flex-col items-center justify-center",children:[(0,b.jsx)("div",{className:"w-[88%] rounded-t-2xl border-[5px] border-slate-800 bg-slate-900 p-1 shadow-xl",children:(0,b.jsx)("div",{className:"aspect-video overflow-hidden rounded-lg bg-gradient-to-br from-sky-300 via-indigo-200 to-emerald-200",children:(0,b.jsx)("div",{className:"h-full w-full bg-[radial-gradient(circle_at_35%_28%,rgba(255,255,255,.9),transparent_18%),linear-gradient(135deg,rgba(255,255,255,.4),transparent_45%)]"})})}),(0,b.jsx)("div",{className:"h-3 w-full rounded-b-2xl bg-slate-300 shadow-md"}),(0,b.jsx)("div",{className:"mt-1 h-1.5 w-[58%] rounded-b-full bg-slate-400/80"})]})]}):(0,b.jsxs)("div",{className:"relative grid h-full w-full place-items-center overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-200",children:[(0,b.jsx)("div",{className:"absolute -left-8 -top-8 h-24 w-24 rounded-full bg-[#00a8e8]/10"}),(0,b.jsx)("div",{className:"absolute -bottom-8 -right-8 h-28 w-28 rounded-full bg-[#0b9c56]/10"}),(0,b.jsxs)("div",{className:"text-center",children:[(0,b.jsx)("div",{className:e?"text-3xl":"text-6xl",children:{laptop:"💻",phone:"📱",car:"🚗",book:"📚",clothes:"👕",home:"🏠",health:"💄",sport:"⚽",toy:"🧸",industrial:"🏭",generic:"🛍️"}[f]}),!e&&(0,b.jsx)("p",{className:"mt-3 rounded-full bg-white/80 px-3 py-1 text-xs font-bold text-gray-600 shadow-sm",children:{laptop:"تصویر لپ‌تاپ",phone:"تصویر موبایل",car:"تصویر خودرو",book:"تصویر کتاب",clothes:"تصویر پوشاک",home:"تصویر کالای خانه",health:"تصویر سلامت",sport:"تصویر ورزشی",toy:"تصویر کودک",industrial:"تصویر صنعتی",generic:"تصویر کالا"}[f]})]})]})}a.s(["ProductHeroImage",0,function({images:a,title:e,category:f,className:g="aspect-square w-28 rounded-2xl"}){let h=a?.[0];return(0,b.jsx)("div",{className:`aspect-square overflow-hidden border border-gray-100 bg-white shadow-inner ${g}`,children:h?(0,b.jsx)("img",{src:(0,c.productImageUrl)(h),alt:`عکس محصول ${e}`,className:"h-full w-full object-contain p-1.5 transition duration-300 group-hover:scale-105",loading:"lazy"}):(0,b.jsx)(d,{title:e,category:f,compact:!0})})},"ProductImageStrip",0,function({images:a,title:d,label:e="عکس‌های محصول",emptyText:f}){return a&&0!==a.length?(0,b.jsxs)("div",{className:"mt-4 rounded-2xl border border-gray-100 bg-gray-50 p-4",children:[(0,b.jsxs)("div",{className:"mb-3 flex items-center justify-between gap-3",children:[(0,b.jsx)("h3",{className:"font-bold text-gray-900",children:e}),(0,b.jsxs)("span",{className:"rounded-full bg-white px-3 py-1 text-xs font-bold text-gray-500",children:[a.length.toLocaleString("fa-IR")," عکس"]})]}),(0,b.jsx)("div",{className:"grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4",children:a.map(a=>(0,b.jsxs)("a",{href:(0,c.productImageUrl)(a),target:"_blank",rel:"noreferrer",className:"group overflow-hidden rounded-2xl border border-white bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md",children:[(0,b.jsx)("div",{className:"aspect-square overflow-hidden bg-gray-100",children:(0,b.jsx)("img",{src:(0,c.productImageUrl)(a),alt:`${d} - ${a.originalName}`,className:"h-full w-full object-cover transition duration-300 group-hover:scale-105",loading:"lazy"})}),(0,b.jsxs)("p",{className:"truncate px-3 py-2 text-xs text-gray-500",children:["seller"===a.uploadedByRole?"فروشنده":"buyer"===a.uploadedByRole?"خریدار":"محصول"," ","· ",a.originalName]})]},a.id||a.storedName))})]}):f?(0,b.jsx)("div",{className:"rounded-2xl border border-dashed border-gray-200 bg-gray-50 p-4 text-sm text-gray-500",children:f}):null},"ProductThumb",0,function({images:a,title:e,category:f,className:g="h-20 w-20"}){let h=a?.[0];return(0,b.jsx)("div",{className:`shrink-0 overflow-hidden rounded-2xl border border-gray-200 bg-gray-100 ${g}`,children:h?(0,b.jsx)("img",{src:(0,c.productImageUrl)(h),alt:`عکس محصول ${e}`,className:"h-full w-full object-contain p-1",loading:"lazy"}):(0,b.jsx)(d,{title:e,category:f,compact:!0})})}])},65365,a=>{"use strict";var b=a.i(72131);let c={cityFa:"تبریز",cityEn:"Tabriz",streetFa:"خیابان ولیعصر",contactAddressFa:"تبریز، خیابان ولیعصر، برج فناوری، طبقه ۱۰",footerAddressFa:"تبریز، خیابان ولیعصر",invoiceCompanyAddressFa:"تبریز، خیابان ولیعصر، مجتمع تجاری نور",invoiceCompanyAddressEn:"No.123, Valiasr St., Tabriz, Iran",invoiceShippingAddressFa:"تبریز، جاده مخصوص، کیلومتر ۱۴",registerCityExampleFa:"تبریز، تبریز"},d=process.env.NEXT_PUBLIC_LIVE_CONTENT_BRANCH||"arena/01a020d5-fazilatma";function e(a){return"string"==typeof a&&a.trim().length>0?a.trim():void 0}process.env.NEXT_PUBLIC_LIVE_CONTENT_URL,process.env.NEXT_PUBLIC_LIVE_CONTENT_API_URL||encodeURIComponent(d);a.s(["getCachedLiveContent",0,function(){return c},"useLiveContent",0,function(a=c){let[d,f]=(0,b.useState)(()=>a);return(0,b.useEffect)(()=>{let a=!1;return fetch(`/api/live-content?ts=${Date.now()}`,{cache:"no-store"}).then(a=>a.ok?a.json():null).then(b=>{let d,g,h,i;!b||a||f((g=e((d=b&&"object"==typeof b?b:{}).cityFa)||c.cityFa,h=e(d.cityEn)||c.cityEn,{cityFa:g,cityEn:h,streetFa:i=e(d.streetFa)||c.streetFa,contactAddressFa:e(d.contactAddressFa)||`${g}، ${i}، برج فناوری، طبقه ۱۰`,footerAddressFa:e(d.footerAddressFa)||`${g}، ${i}`,invoiceCompanyAddressFa:e(d.invoiceCompanyAddressFa)||`${g}، ${i}، مجتمع تجاری نور`,invoiceCompanyAddressEn:e(d.invoiceCompanyAddressEn)||`No.123, Valiasr St., ${h}, Iran`,invoiceShippingAddressFa:e(d.invoiceShippingAddressFa)||`${g}، جاده مخصوص، کیلومتر ۱۴`,registerCityExampleFa:e(d.registerCityExampleFa)||`${g}، ${g}`}))}).catch(()=>void 0),()=>{a=!0}},[]),d}],65365)},32240,a=>{"use strict";var b=a.i(87924),c=a.i(72131);a.s(["default",0,function({sellerId:a,sellerName:d,sellerPhone:e,sellerEmail:f,requestId:g,requestTitle:h,requestBuyerId:i,compact:j=!1,className:k=""}){let[l,m]=(0,c.useState)(null),[n,o]=(0,c.useState)(0),[p,q]=(0,c.useState)(!1),[r,s]=(0,c.useState)(!1),[t,u]=(0,c.useState)(""),v=(0,c.useMemo)(()=>String(e||"").trim(),[e]),w=(0,c.useMemo)(()=>{let a;return!(a=String(f||"").trim())||a.includes("@phone.optibid.local")?"":a},[f]),x=!!(v||w);(0,c.useEffect)(()=>{m(localStorage.getItem("userRole")),o(Number(localStorage.getItem("userId")||0))},[]);let y=()=>!!(n||(sessionStorage.setItem("redirectAfterAuth","/"),window.location.href="/login",0))&&!!(!i||n===i||(alert("برای حفظ حریم خصوصی فروشنده، اطلاعات تماس و شروع ارتباط فقط برای خریدار صاحب همین درخواست فعال است."),0))&&("admin"!==l||(alert("ادمین برای ارتباط با فروشنده باید با حساب خریدار/فروشنده وارد شود."),!1)),z=async()=>{if(y()&&!r){s(!0),u("");try{let b=h?`برای درخواست \xab${h}\xbb${g?` (کد ${g})`:""}`:`برای پروفایل فروشنده \xab${d}\xbb`,c=await fetch("/api/messages",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({senderId:n,receiverId:a,content:`درخواست تماس امن از طریق OptiBid ${b}. لطفاً بدون نمایش شماره تلفن، زمان و روش هماهنگی را در چت OptiBid اعلام کنید.`})}),e=await c.json();if(!e.success)throw Error(e.message||"ارسال درخواست تماس ناموفق بود.");u("درخواست تماس امن برای فروشنده ارسال شد؛ پاسخ فروشنده در پیام‌های OptiBid نمایش داده می‌شود.")}catch(a){alert(a instanceof Error?a.message:"ارسال درخواست تماس از طریق OptiBid ناموفق بود.")}finally{s(!1)}}};return(0,b.jsxs)("div",{className:`${j?"rounded-3xl border border-sky-100 bg-gradient-to-l from-sky-50/90 to-white p-4 shadow-sm":"rounded-3xl border border-sky-100 bg-white p-6 shadow-sm"} ${k}`,dir:"rtl",children:[(0,b.jsxs)("div",{className:"mb-4 flex flex-col justify-between gap-3 md:flex-row md:items-start",children:[(0,b.jsxs)("div",{className:"min-w-0",children:[(0,b.jsx)("p",{className:"text-sm font-black text-[#003b5c]",children:"راه‌های ارتباط با فروشنده"}),(0,b.jsx)("p",{className:"mt-1 text-xs leading-6 text-slate-600",children:"خریدار می‌تواند مستقیم، بدون نمایش شماره یا با چت داخلی OptiBid هماهنگ کند."})]}),(0,b.jsx)("span",{className:"w-fit shrink-0 rounded-full bg-emerald-50 px-3 py-1 text-xs font-black text-emerald-700",children:"هر ۳ گزینه فعال"})]}),(0,b.jsxs)("div",{className:"grid gap-3 md:grid-cols-3",children:[(0,b.jsxs)("button",{type:"button",onClick:()=>{y()&&(u(""),q(a=>!a))},className:"flex min-h-24 items-center gap-3 rounded-2xl border border-emerald-200 bg-white px-4 py-3 text-right text-xs font-bold text-emerald-800 shadow-sm transition hover:-translate-y-0.5 hover:border-emerald-400 hover:bg-emerald-50",children:[(0,b.jsx)("span",{className:"grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-emerald-50 text-lg",children:"📞"}),(0,b.jsxs)("span",{className:"min-w-0",children:[(0,b.jsx)("span",{className:"block",children:"اطلاعات تماس فروشنده"}),(0,b.jsx)("span",{className:"mt-1 block font-normal leading-5 text-emerald-700/80",children:x?"شماره/ایمیل مستقیم":"در انتظار تکمیل پروفایل"})]})]}),(0,b.jsxs)("button",{type:"button",onClick:z,disabled:r,className:"flex min-h-24 items-center gap-3 rounded-2xl border border-blue-200 bg-white px-4 py-3 text-right text-xs font-bold text-blue-800 shadow-sm transition hover:-translate-y-0.5 hover:border-blue-400 hover:bg-blue-50 disabled:cursor-wait disabled:opacity-60",children:[(0,b.jsx)("span",{className:"grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-blue-50 text-lg",children:"☎️"}),(0,b.jsxs)("span",{className:"min-w-0",children:[(0,b.jsx)("span",{className:"block",children:"تماس از طریق OptiBid"}),(0,b.jsx)("span",{className:"mt-1 block font-normal leading-5 text-blue-700/80",children:r?"در حال ارسال درخواست...":"بدون نمایش شماره"})]})]}),(0,b.jsxs)("button",{type:"button",onClick:()=>{if(!y())return;sessionStorage.setItem("optibidChatTargetId",String(a)),sessionStorage.setItem("optibidChatTargetName",d);let b=new URLSearchParams({tab:"messages",chatWith:String(a),chatName:d});window.location.href=`/buyer/dashboard?${b.toString()}`},className:"flex min-h-24 items-center gap-3 rounded-2xl border border-violet-200 bg-white px-4 py-3 text-right text-xs font-bold text-violet-800 shadow-sm transition hover:-translate-y-0.5 hover:border-violet-400 hover:bg-violet-50",children:[(0,b.jsx)("span",{className:"grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-violet-50 text-lg",children:"💬"}),(0,b.jsxs)("span",{className:"min-w-0",children:[(0,b.jsx)("span",{className:"block",children:"چت از طریق OptiBid"}),(0,b.jsx)("span",{className:"mt-1 block font-normal leading-5 text-violet-700/80",children:"گفتگو داخل داشبورد"})]})]})]}),p&&(0,b.jsxs)("div",{className:"mt-3 rounded-2xl border border-emerald-100 bg-white p-4 text-sm leading-7 text-slate-700",children:[x?(0,b.jsxs)("div",{className:"space-y-2",children:[(0,b.jsxs)("p",{className:"font-bold text-emerald-800",children:["اطلاعات تماس مستقیم ",d]}),v&&(0,b.jsxs)("a",{href:`tel:${v.replace(/\s+/g,"")}`,className:"flex flex-wrap items-center justify-between gap-2 rounded-xl bg-emerald-50 px-3 py-2 font-bold text-emerald-800",dir:"ltr",children:[(0,b.jsx)("span",{children:v}),(0,b.jsx)("span",{dir:"rtl",children:"تماس تلفنی"})]}),w&&(0,b.jsxs)("a",{href:`mailto:${w}`,className:"flex flex-wrap items-center justify-between gap-2 rounded-xl bg-slate-50 px-3 py-2 font-bold text-slate-700",dir:"ltr",children:[(0,b.jsx)("span",{children:w}),(0,b.jsx)("span",{dir:"rtl",children:"ارسال ایمیل"})]})]}):(0,b.jsx)("p",{className:"text-amber-700",children:"فروشنده هنوز شماره یا ایمیل مستقیم را در پروفایل ثبت نکرده است؛ از «تماس از طریق OptiBid» یا «چت از طریق OptiBid» استفاده کنید."}),(0,b.jsx)("p",{className:"mt-3 text-xs leading-6 text-slate-500",children:"برای فروشنده‌هایی که نمی‌خواهند شماره‌شان عمومی شود، دو مسیر امن OptiBid فعال است و شماره طرفین نمایش داده نمی‌شود."})]}),t&&(0,b.jsx)("p",{className:"mt-3 rounded-2xl border border-emerald-100 bg-emerald-50 px-4 py-3 text-xs font-bold leading-6 text-emerald-800",children:t})]})}])},38136,a=>{"use strict";var b=a.i(87924);let c={sm:"text-sm",md:"text-lg",lg:"text-2xl"};a.s(["default",0,function({score:a,size:d="md",showLabel:e=!0,light:f=!1,className:g=""}){let h=Math.max(0,Math.min(5,a/20)),i=Math.round(h);return(0,b.jsxs)("div",{className:`inline-flex items-center gap-1.5 ${g}`,"aria-label":`امتیاز ${h.toFixed(1)} از ۵`,children:[(0,b.jsx)("span",{className:`tracking-tight text-amber-400 ${c[d]}`,"aria-hidden":"true",children:Array.from({length:5},(a,b)=>b<i?"★":"☆").join("")}),e&&(0,b.jsxs)("span",{className:`font-bold ${f?"text-white":"text-[#003b5c]"}`,children:[h.toLocaleString("fa-IR",{minimumFractionDigits:1,maximumFractionDigits:1}),(0,b.jsx)("span",{className:`mr-0.5 text-xs font-normal ${f?"text-blue-100":"text-gray-500"}`,children:"از ۵"})]})]})}])},8826,a=>{"use strict";var b=a.i(87924),c=a.i(72131);let d={buyer:[["quality","کیفیت و سلامت کالا"],["match","تطابق کالا با پیشنهاد"],["shipping","سرعت و تعهد در ارسال"],["packaging","بسته‌بندی و تحویل"],["communication","پاسخ‌گویی و رفتار فروشنده"]],seller:[["clarity","شفافیت و دقت درخواست"],["cooperation","همکاری در فرایند معامله"],["communication","ارتباط و پاسخ‌گویی خریدار"],["receipt","سرعت بررسی و تایید دریافت"],["conduct","رفتار حرفه‌ای در معامله"]]};function e({value:a,onChange:c}){return(0,b.jsx)("div",{className:"flex gap-1",dir:"ltr",children:[1,2,3,4,5].map(d=>{let e=d<=a;return(0,b.jsx)("button",{type:"button",onClick:()=>c(d),className:`text-3xl transition hover:scale-110 ${e?"text-amber-400":"text-gray-300 hover:text-amber-300"}`,"aria-label":`${d} ستاره`,children:e?"★":"☆"},d)})})}a.s(["default",0,function({role:a,reviewerId:f,order:g,onSaved:h}){let i=d[a],[j,k]=(0,c.useState)(Object.fromEntries(i.map(([a])=>[a,0]))),[l,m]=(0,c.useState)(""),[n,o]=(0,c.useState)(!1),p=Object.values(j).filter(a=>a>0),q=p.length===i.length,r=q?Math.round(p.reduce((a,b)=>a+b,0)/p.length):0,s="buyer"===a?g.sellerName:g.buyerName,t=async()=>{if(!q)return void alert("لطفاً برای همه معیارهای نظرسنجی امتیاز ستاره‌ای ثبت کنید.");o(!0);try{let a=await fetch("/api/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({orderId:g.id,reviewerId:f,overall:r,scores:j,comment:l})}),b=await a.json();if(!b.success)throw Error(b.message);alert(b.message),await h()}catch(a){alert(a instanceof Error?a.message:"ثبت نظرسنجی ناموفق بود.")}finally{o(!1)}};return(0,b.jsxs)("article",{className:"rounded-3xl border border-gray-200 bg-white p-6 shadow-sm",children:[(0,b.jsxs)("div",{className:"mb-5 flex flex-col justify-between gap-3 sm:flex-row sm:items-center",children:[(0,b.jsxs)("div",{children:[(0,b.jsxs)("p",{className:"text-xs font-bold text-[#00a8e8]",children:["سفارش ",g.id]}),(0,b.jsxs)("h3",{className:"mt-1 text-lg font-bold text-[#003b5c]",children:["ارزیابی ",s]}),(0,b.jsx)("p",{className:"mt-1 text-sm text-gray-500",children:g.title})]}),(0,b.jsxs)("div",{className:"rounded-xl bg-amber-50 px-4 py-2 text-center",children:[(0,b.jsxs)("p",{className:"text-2xl text-amber-400",children:["★".repeat(r),"☆".repeat(5-r)]}),(0,b.jsx)("p",{className:"text-xs font-bold text-amber-800",children:q?`امتیاز نهایی ${r} از ۵`:"هنوز امتیازی ثبت نشده"})]})]}),(0,b.jsx)("div",{className:"space-y-3 border-y border-gray-100 py-5",children:i.map(([a,c])=>(0,b.jsxs)("div",{className:"flex flex-col justify-between gap-2 rounded-xl bg-gray-50 px-4 py-3 sm:flex-row sm:items-center",children:[(0,b.jsx)("span",{className:"text-sm font-bold text-gray-700",children:c}),(0,b.jsx)(e,{value:j[a],onChange:b=>k({...j,[a]:b})})]},a))}),(0,b.jsx)("label",{className:"mt-5 block text-sm font-bold text-gray-700",children:"توضیحات شما (اختیاری)"}),(0,b.jsx)("textarea",{value:l,onChange:a=>m(a.target.value),placeholder:"تجربه واقعی خود از این معامله را بنویسید...",className:"mt-2 min-h-24 w-full rounded-xl border border-gray-200 p-3 text-sm outline-none focus:border-[#00a8e8]"}),(0,b.jsx)("p",{className:"mt-2 text-xs leading-6 text-gray-500",children:"متن این بخش دقیقاً در قسمت «دیدگاه‌ها» صفحه طرف مقابل نمایش داده می‌شود."}),(0,b.jsx)("button",{type:"button",disabled:n||!q,onClick:t,className:"mt-4 rounded-xl bg-[#003b5c] px-6 py-3 text-sm font-bold text-white transition hover:bg-[#002d46] disabled:bg-gray-400",children:n?"در حال ثبت...":"ثبت نهایی امتیاز و نظر"})]})}])},73767,a=>{"use strict";var b=a.i(65365);function c(a){return"number"==typeof a?Math.max(0,Math.round(a)):Math.max(0,Number(String(a||"").replace(/[۰-۹]/g,a=>String("۰۱۲۳۴۵۶۷۸۹".indexOf(a))).replace(/[٠-٩]/g,a=>String("٠١٢٣٤٥٦٧٨٩".indexOf(a))).replace(/\D/g,""))||0)}function d(a){let b=c(a);return b?`${b.toLocaleString("fa-IR")} تومان`:"۰ تومان"}function e(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function f(a,b){return b?`<div class="spec-row"><span>${e(a)}</span><b>${e(b)}</b></div>`:""}a.s(["generateInvoiceHTML",0,a=>{var g;let h=(0,b.getCachedLiveContent)(),i=a.id||a.orderId||`INV-${Date.now()}`,j=a.date||new Date().toLocaleDateString("fa-IR"),k=a.sellerName||a.seller||"فروشنده OptiBid",l=a.buyerName||a.buyer||"خریدار OptiBid",m=a.product||a.title||"کالای مورد معامله",n=a.description||a.productDescription||"",o=a.category||"کالا / خدمات",p=Math.max(1,Number(a.quantity||1)||1),q=c(a.totalAmount??a.amount),r=c(a.unitAmount)||Math.round(q/p),s=c(a.platformFee),t=c(a.sellerAmount)||Math.max(0,q-s),u=c(a.taxAmount),v=c(a.shippingAmount),w=q+u+v,x=a.productSpecs||{},y=`https://optibid.fazilat-ma.workers.dev/verify/${encodeURIComponent(i)}`,z=x.brand||a.brand||"—",A=[x.exactModel,x.cpu,x.ram,x.storage].filter(Boolean).join(" · "),B=[f("برند",x.brand),f("مدل دقیق",x.exactModel),f("کد مدل / کانفیگ",x.serialOrConfig),f("پردازنده",x.cpu),f("رم",x.ram),f("حافظه",x.storage),f("گرافیک",x.gpu),f("نمایشگر",x.display),f("سال ساخت",x.manufactureYear),f("وضعیت کالا",x.productCondition),f("گارانتی",x.warrantyStatus),f("سلامت کلی قطعات",x.partsHealth),f("سلامت باتری",x.batteryHealthPercent?`${x.batteryHealthPercent}%`:""),f("گرید ظاهری",x.appearanceGrade),f("سابقه تعمیر",x.repairHistory),f("مهلت تست",x.testDeadlineDays?`${x.testDeadlineDays} روز`:"")].filter(Boolean).join("");return`<!DOCTYPE html>
...
//# sourceMappingURL=src_1nvgsvp._.js.map