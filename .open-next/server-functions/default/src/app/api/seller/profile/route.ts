...
import { updateJsonSellerProfile, type JsonKycDocument } from "@/lib/json-store";
...
export async function PATCH(request: Request) {
  ...
  try {
    ...
    if (contentType.includes("multipart/form-data")) {
      ...
      return NextResponse.json({ success: true, seller, message: "اطلاعات حساب فروشنده ذخیره شد." });
    }
