  ...
  const categoriesDb = [
    {
      ...
      icon: "📱",
      desc: "تجهیزات الکترونیکی، موبایل، لپ‌تاپ و سرور",
    },
    {
      id: 2,
      nameFa: "مد و پوشاک",
      icon: "👕",
      desc: "خرید عمده پوشاک، کیف و کفش و اکسسوری",
    },
    {
      id: 3,
      nameFa: "خانه و آشپزخانه",
      icon: "🏠",
      desc: "تجهیزات خانگی، دکوراسیون و ظروف صنعتی",
    },
    {
      id: 4,
      nameFa: "زیبایی و سلامت",
      icon: "💄",
      desc: "محصولات آرایشی، بهداشتی و تجهیزات پزشکی",
    },
    {
      id: 5,
      nameFa: "کتاب و لوازم تحریر",
      icon: "📚",
      desc: "کتب آموزشی، نوشت‌افزار و تجهیزات اداری",
    },
    {
      id: 6,
      nameFa: "ورزش و سفر",
      icon: "⚽",
      desc: "لوازم ورزشی، کمپینگ و پوشاک ورزشی",
    },
    {
      id: 7,
      nameFa: "اسباب‌بازی و کودک",
      icon: "🧸",
      desc: "خرید اسباب‌بازی، سیسمونی و لباس کودک",
    },
    {
      id: 8,
      nameFa: "خودرو و موتور",
      icon: "🚗",
      desc: "لوازم یدکی، تجهیزات خودرو و ابزار",
    },
  ];
    ...
    <div dir="rtl" className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-[#003b5c] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-[#00a8e8] text-lg max-w-2xl mx-auto">
            {category.desc}
          </p>
        </div>
      </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              <div className="flex justify-between items-center mb-6 border-b border-gray-100 pb-4">
                <h2 className="text-xl font-bold text-gray-900">
                  آخرین درخواست‌های خرید ({category.nameFa})
                </h2>
                <Link
                  href={`/requests?category=${category.nameFa}`}
                  className="text-sm text-[#00a8e8] font-bold hover:underline"
                >
                  مشاهده همه
                </Link>
              </div>
                ...
                {categoryRequests.length === 0 ? (
                  <div className="rounded-xl border border-dashed border-gray-300 bg-gray-50 px-6 py-12 text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      اولین درخواست واقعی این دسته را ثبت کنید.
                    </p>
                  </div>
                ) : (
                    ...
                    >
                      ...
                      <div className="mt-4 flex items-end justify-between">
                        <div>
                          ...
                          <div className="font-bold text-[#00a8e8]">
                            {req.budget}
                          </div>
                        </div>
          ...
          <div className="md:col-span-1 space-y-6">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 text-center">
              <h3 className="font-bold text-gray-900 mb-4">
                آیا در حوزه {category.nameFa} فعالیت دارید؟
              </h3>
              <p className="text-sm text-gray-500 mb-6">
                درخواست خود را برای تامین کالا ثبت کنید یا به عنوان فروشنده وارد
                شوید.
              </p>
              <div className="space-y-3">
                <Link
                  href="/request-purchase"
                  className="block w-full bg-[#00a8e8] hover:bg-blue-600 text-white font-bold py-3 rounded-xl transition"
                >
                  ثبت درخواست خرید
                </Link>
                <Link
                  href="/become-seller"
                  className="block w-full bg-[#003b5c] hover:bg-gray-800 text-white font-bold py-3 rounded-xl transition"
                >
                  ...
                  categorySellers.map((seller) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-sm font-bold text-gray-800 transition group-hover:text-[#00a8e8]">
                            {seller.name}
                          </div>
                          <div className="text-xs text-gray-500">
                            ⭐ {seller.rating} | {seller.sales} فروش
                          </div>
                        </div>
                      </div>
                      <svg
                        className="h-4 w-4 text-gray-300 group-hover:text-[#00a8e8]"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
