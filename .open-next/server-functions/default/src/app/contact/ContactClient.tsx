...
import { type LiveContent } from "@/lib/live-content";
import { useLiveContent } from "@/hooks/useLiveContent";

export default function ContactClient({ initialContent }: { initialContent: LiveContent }) {
  const liveContent = useLiveContent(initialContent);
