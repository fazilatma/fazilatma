            ...
            <div class="max-w-6xl mx-auto px-4">
                ...
                <div id="requests" class="tab-content max-w-4xl mx-auto">
                    ...
                    <div class="bg-white border border-gray-200 rounded-3xl p-6 shadow-sm relative transition hover:shadow-md">
                        ...
                        <p class="text-sm text-gray-600 mb-4 border-r-2 border-[#00a8e8] pr-3">موبایل • بودجه: ۶۵,۰۰۰,۰۰۰ تومان • دزفول<br>رنگ تیتانیوم مشکی، رجیستر شده، آکبند</p>
                        ...
                        <div class="space-y-8">
                            ...
                            <div>
                                ...
                                <div class="grid md:grid-cols-2 gap-6 mb-4">
                                    ...
                                    <div class="relative">
                                        <input type="text" value="دزفول" class="peer w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-right focus:outline-none">
