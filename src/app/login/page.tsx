...
export default function LoginPage() {
  ...
  useEffect(() => {
    const pendingUsername = new URLSearchParams(window.location.search).get("pending");
    if (pendingUsername) {
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-gradient-to-l from-green-600 to-green-800 flex items-center justify-center py-12 px-4">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-xl">
          {pendingApproval && (
            <div className="mb-6 rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm leading-7 text-amber-800">
              ثبت‌نام شما انجام شد و مدارک در انتظار بررسی ادمین هستند. نام کاربری پس از تایید مدارک فعال می‌شود.
            </div>
          )}
