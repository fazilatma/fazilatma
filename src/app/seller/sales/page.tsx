...
export default function SellerSalesPage() {
  ...
  const filteredSales =
    activeTab === "all" ? sales : sales.filter((s) => s.status === activeTab);
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            مدیریت معاملات، ارسال کالا و پیگیری تسویه حساب کمیسیون.
          </p>
        </div>
              ...
              >
                ...
                <div className="bg-gray-50 p-4 border-b border-gray-100 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-bold ${sale.statusColor}`}
                    >
                      {sale.statusLabel}
                    </span>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-100">
                    <button
                      onClick={() => {
                        const invoiceHTML = generateInvoiceHTML({
                          ...
                          status: sale.status,
                          sellerAmount: sale.sellerReceives,
                          platformFee: sale.feeAmount,
                        });
                    ...
                    {sale.canGetPaid && (
                      <div className="text-sm text-orange-700 bg-orange-50 px-4 py-2.5 rounded-lg flex-1 flex items-center justify-center">
                        پس از تایید نهایی خریدار، مبلغ به کیف پول شما واریز
                        می‌شود.
                      </div>
                    )}
