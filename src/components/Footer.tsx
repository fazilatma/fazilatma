        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-4">
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-green-600 transition"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
          ...
          <div>
            ...
            <ul className="space-y-2 space-y-reverse text-gray-400">
              ...
              <li>
                <Link href="/rules" className="hover:text-green-400 transition">
                  قوانین و مقررات
                </Link>
              </li>
              <li>
