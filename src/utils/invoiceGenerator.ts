          ...
          <table class="w-full text-xs">
            <tr>
              ...
              <td class="py-2 leading-relaxed">
                <div class="font-bold text-gray-800">اهواز، خیابان ولیعصر، مجتمع تجاری نور</div>
                <div class="text-gray-500" dir="ltr">No.123, Valiasr St., Ahvaz, Iran</div>
              </td>
            </tr>
            <tr>
        ...
        <div class="w-1/2">
          ...
          <table class="w-full text-xs">
            ...
            <tr>
              ...
              <td class="py-1.5 font-bold text-gray-800 text-left">اهواز، جاده مخصوص، کیلومتر ۱۴</td>
            </tr>
            <tr>
